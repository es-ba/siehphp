create or replace view var_orden as 
    ...
    from formularios
        inner join bloques on blo_ope=for_ope and blo_for=for_for
        inner join preguntas on blo_ope=pre_ope and blo_for=pre_for and blo_blo=pre_blo 
        inner join variables on pre_ope=var_ope and pre_pre=var_pre 
