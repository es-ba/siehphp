...
UPDATE encu.variables
        set var_orden=1
        where var_ope='eah2024' and var_var='v5_esp';
UPDATE encu.variables
        set var_orden=1
        where var_ope='eah2024' and var_var='lugar_esp1';
UPDATE encu.variables
        set var_orden=3
        where var_ope='eah2024' and var_var='lugar_esp3';
UPDATE encu.variables
        set var_orden=12
        where var_ope='eah2024' and var_var='sn15k_esp';
...
--SELECT encu.variables_saltadas('eah2024','t3','t13'), ('t3') --{t4,t5,t6,t7,t8,t8_otro,t9,t10,t11,t11_otro,t12}
