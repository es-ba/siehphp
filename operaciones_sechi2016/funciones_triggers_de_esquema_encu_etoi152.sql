...
--
-- TOC entry 661 (class 1255 OID 840376)
-- Name: calcular_idhog_idmie_aleatorio_trg(); Type: FUNCTION; Schema: encu; Owner: tedede_php
--

CREATE OR REPLACE FUNCTION calcular_idhog_idmie_aleatorio_trg() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
...
ALTER FUNCTION encu.calcular_idhog_idmie_aleatorio_trg() OWNER TO tedede_php;

--
-- TOC entry 587 (class 1255 OID 766433)
...
BEGIN
  ...
  then
    ...
    if v_estado_final is null and ((dbo.norea_recuperable(v_norea) OR v_norea=18) AND v_verificado_enc<>0 AND v_dominio = 3) then v_estado_final:=30; end if; /*G:E*/
...
--
-- TOC entry 543 (class 1255 OID 762413)
...
--
-- TOC entry 544 (class 1255 OID 762414)
...
--
-- TOC entry 616 (class 1255 OID 766440)
...
CREATE OR REPLACE FUNCTION controlar_modificacion_semana_trg() RETURNS trigger
    ...
    if new.pla_semana is distinct from old.pla_semana then 
        if new.pla_dominio is not distinct from 4 and 
            (new.pla_sel_etoi14_villa is not distinct from 0 or ( new.pla_sel_etoi14_villa is not distinct from 1 and 
            new.pla_estado in (null, 18,19,20,21,22,69) )) then
                new.pla_replica=new.pla_semana;
        else
            raise exception 'No se puede modificar la semana en encuestas que no cumplen: dominio 4 y (sel_etoi14_villa=1 y estado <=22 o 69; or sel_etoi14_villa=0)';    
        end if;        
    end if;   
    return new;
    END
...
--
-- TOC entry 659 (class 1255 OID 840377)
-- Name: correr_calculo_aleatorio_hog(); Type: FUNCTION; Schema: encu; Owner: tedede_php
--

CREATE OR REPLACE FUNCTION correr_calculo_aleatorio_hog() RETURNS void
    LANGUAGE plpgsql
    AS $$
DECLARE
 venc   RECORD;
...
ALTER FUNCTION encu.correr_calculo_aleatorio_hog() OWNER TO tedede_php;

--
-- TOC entry 660 (class 1255 OID 840378)
-- Name: correr_calculo_aleatorio_mie(); Type: FUNCTION; Schema: encu; Owner: tedede_php
--

CREATE OR REPLACE FUNCTION correr_calculo_aleatorio_mie() RETURNS void
    LANGUAGE plpgsql
    AS $$
DECLARE
 vmie   RECORD;
...
ALTER FUNCTION encu.correr_calculo_aleatorio_mie() OWNER TO tedede_php;

--
-- TOC entry 611 (class 1255 OID 766441)
...
--
-- TOC entry 612 (class 1255 OID 766442)
...
--
-- TOC entry 613 (class 1255 OID 766443)
...
--
-- TOC entry 614 (class 1255 OID 766446)
...
--
-- TOC entry 617 (class 1255 OID 766447)
...
--
-- TOC entry 618 (class 1255 OID 766448)
...
BEGIN  
    ...
    INSERT INTO encu.consistencias( con_ope,con_con,con_precondicion,con_rel,
        ...
        SELECT  var_ope, 'audi_nsnc_'||var_var, 'informado('||var_var||')' as precondicion, xcon_rel,
            ...
            WHERE var_ope=poperativo and var_for is distinct from 'SUP'
            ORDER BY orden; 
END;
$$;
...
--
-- TOC entry 615 (class 1255 OID 766449)
...
--
-- TOC entry 619 (class 1255 OID 766450)
...
--
-- TOC entry 620 (class 1255 OID 766451)
...
--
-- TOC entry 621 (class 1255 OID 766452)
...
--
-- TOC entry 622 (class 1255 OID 766455)
...
--
-- TOC entry 624 (class 1255 OID 766458)
...
--
-- TOC entry 625 (class 1255 OID 766459)
...
--
-- TOC entry 545 (class 1255 OID 762415)
...
--
-- TOC entry 623 (class 1255 OID 762416)
...
--
-- TOC entry 626 (class 1255 OID 766462)
...
--
-- TOC entry 627 (class 1255 OID 766463)
...
--
-- TOC entry 628 (class 1255 OID 766464)
...
--
-- TOC entry 629 (class 1255 OID 766465)
...
--
-- TOC entry 630 (class 1255 OID 766466)
...
--
-- TOC entry 631 (class 1255 OID 766467)
...
--
-- TOC entry 632 (class 1255 OID 766468)
...
--
-- TOC entry 633 (class 1255 OID 766469)
...
--
-- TOC entry 635 (class 1255 OID 766470)
...
--
-- TOC entry 637 (class 1255 OID 766471)
...
--
-- TOC entry 655 (class 1255 OID 811012)
-- Name: reemplazar_espacios_por_x_o_blanco_total(text); Type: FUNCTION; Schema: encu; Owner: postgres
--

CREATE OR REPLACE FUNCTION reemplazar_espacios_por_x_o_blanco_total(p_texto text) RETURNS text
    LANGUAGE sql
    AS $$
...
ALTER FUNCTION encu.reemplazar_espacios_por_x_o_blanco_total(p_texto text) OWNER TO postgres;

--
-- TOC entry 657 (class 1255 OID 762417)
...
--
-- TOC entry 636 (class 1255 OID 766472)
...
--
-- TOC entry 638 (class 1255 OID 766473)
...
--
-- TOC entry 650 (class 1255 OID 762418)
...
--
-- TOC entry 639 (class 1255 OID 766474)
...
--
-- TOC entry 640 (class 1255 OID 766475)
...
--
-- TOC entry 641 (class 1255 OID 766476)
...
--
-- TOC entry 656 (class 1255 OID 811013)
-- Name: unir_rama_ocupacion_trg(); Type: FUNCTION; Schema: encu; Owner: tedede_php
--

CREATE OR REPLACE FUNCTION unir_rama_ocupacion_trg() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
v_nota text;
...
ALTER FUNCTION encu.unir_rama_ocupacion_trg() OWNER TO tedede_php;

--
-- TOC entry 653 (class 1255 OID 810827)
-- Name: validacion_rama_ocupacion_trg(); Type: FUNCTION; Schema: encu; Owner: tedede_php
--

CREATE OR REPLACE FUNCTION validacion_rama_ocupacion_trg() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
v_nota text;
...
ALTER FUNCTION encu.validacion_rama_ocupacion_trg() OWNER TO tedede_php;

--
-- TOC entry 642 (class 1255 OID 766477)
...
--
-- TOC entry 634 (class 1255 OID 766478)
...
--
-- TOC entry 643 (class 1255 OID 766481)
...
--
-- TOC entry 549 (class 1255 OID 762419)
...
--
-- TOC entry 648 (class 1255 OID 803425)
...
CREATE VIEW variables_ordenadas AS
 SELECT b.blo_for, 
    b.blo_blo, 
    b.blo_texto, 
    b.blo_incluir_mat, 
    ...
    v.var_calculada, 
    p.pre_orden, 
    row_number() OVER (ORDER BY f.for_orden, b.blo_orden, b.blo_mat, p.pre_orden, comun.para_ordenar_numeros(COALESCE((v.var_orden)::text, (v.var_var)::text)), COALESCE(v.var_subordinada_var, ''::character varying)) AS orden, 
    last_value(v.var_var) OVER (PARTITION BY b.blo_for ORDER BY f.for_orden, b.blo_orden, b.blo_mat, p.pre_orden, comun.para_ordenar_numeros(COALESCE((v.var_orden)::text, (v.var_var)::text)), COALESCE(v.var_subordinada_var, ''::character varying) ROWS BETWEEN UNBOUNDED PRECEDING AND UNBOUNDED FOLLOWING) AS var_ultima_for, 
    lead(v.var_var, 1, 'fin'::character varying) OVER (ORDER BY f.for_orden, b.blo_orden, b.blo_mat, p.pre_orden, comun.para_ordenar_numeros(COALESCE((v.var_orden)::text, (v.var_var)::text)), v.var_pre) AS var_siguiente
   FROM (((variables v
   JOIN preguntas p ON ((((((p.pre_ope)::text = (v.var_ope)::text) AND ((p.pre_pre)::text = (v.var_pre)::text)) AND ((p.pre_for)::text = (v.var_for)::text)) AND ((p.pre_mat)::text = (v.var_mat)::text))))
   JOIN bloques b ON ((((((b.blo_blo)::text = (p.pre_blo)::text) AND ((b.blo_ope)::text = (p.pre_ope)::text)) AND ((b.blo_for)::text = (p.pre_for)::text)) AND ((b.blo_mat)::text = (p.pre_mat)::text))))
   JOIN formularios f ON ((((f.for_for)::text = (b.blo_for)::text) AND ((f.for_ope)::text = (b.blo_ope)::text))))
  WHERE ((f.for_for)::text <> 'TEM'::text)
  ORDER BY f.for_orden, b.blo_orden, b.blo_mat, p.pre_orden, comun.para_ordenar_numeros(COALESCE((v.var_orden)::text, (v.var_var)::text)), COALESCE(v.var_subordinada_var, ''::character varying);


ALTER TABLE encu.variables_ordenadas OWNER TO tedede_php;

--
-- TOC entry 270 (class 1259 OID 763089)
-- Name: verificado; Type: TABLE; Schema: encu; Owner: tedede_php; Tablespace: 
--


--
-- TOC entry 3519 (class 2620 OID 840396)
-- Name: calcular_idhog_aleatorio_trg; Type: TRIGGER; Schema: encu; Owner: tedede_php
--

CREATE TRIGGER calcular_idhog_aleatorio_trg BEFORE INSERT ON plana_s1_ FOR EACH ROW EXECUTE PROCEDURE calcular_idhog_idmie_aleatorio_trg();


--
-- TOC entry 3517 (class 2620 OID 840397)
-- Name: calcular_idmie_aleatorio_trg; Type: TRIGGER; Schema: encu; Owner: tedede_php
--

CREATE TRIGGER calcular_idmie_aleatorio_trg BEFORE INSERT ON plana_i1_ FOR EACH ROW EXECUTE PROCEDURE calcular_idhog_idmie_aleatorio_trg();


--
-- TOC entry 3528 (class 2620 OID 847167)
...
--
-- TOC entry 3509 (class 2620 OID 766486)
...
--
-- TOC entry 3510 (class 2620 OID 840415)
...
--
-- TOC entry 3511 (class 2620 OID 766488)
...
--
-- TOC entry 3520 (class 2620 OID 766489)
...
--
-- TOC entry 3521 (class 2620 OID 766490)
...
--
-- TOC entry 3512 (class 2620 OID 766491)
...
--
-- TOC entry 3513 (class 2620 OID 766492)
...
--
-- TOC entry 3522 (class 2620 OID 766493)
...
--
-- TOC entry 3527 (class 2620 OID 840418)
...
--
-- TOC entry 3523 (class 2620 OID 766495)
...
--
-- TOC entry 3524 (class 2620 OID 766496)
...
--
-- TOC entry 3526 (class 2620 OID 840417)
...
--
-- TOC entry 3525 (class 2620 OID 766498)
...
--
-- TOC entry 3529 (class 2620 OID 766499)
...
--
-- TOC entry 3515 (class 2620 OID 811014)
-- Name: unir_rama_ocupacion_i1_trg; Type: TRIGGER; Schema: encu; Owner: tedede_php
--

CREATE TRIGGER unir_rama_ocupacion_i1_trg BEFORE UPDATE ON plana_i1_ FOR EACH ROW EXECUTE PROCEDURE unir_rama_ocupacion_trg();


--
-- TOC entry 3514 (class 2620 OID 810828)
-- Name: validacion_rama_ocupacion_i1_trg; Type: TRIGGER; Schema: encu; Owner: tedede_php
--

CREATE TRIGGER validacion_rama_ocupacion_i1_trg BEFORE UPDATE ON plana_i1_ FOR EACH ROW EXECUTE PROCEDURE validacion_rama_ocupacion_trg();


--
-- TOC entry 3531 (class 2620 OID 766500)
...
--
-- TOC entry 3532 (class 2620 OID 766501)
...
--
-- TOC entry 3530 (class 2620 OID 840416)
...
--
-- TOC entry 3364 (class 2606 OID 764716)
-- Name: a_ingreso_tiempo_logico_fk; Type: FK CONSTRAINT; Schema: encu; Owner: tedede_php
--
