    ...
    INSERT INTO encu.consistencias( con_ope,con_con,con_precondicion,con_rel,
        ...
        (xoperativo, 'compl_S1','', xcon_rel,
            'entrea=2 and(razon1=1 and informado(razon2_1) or'
                ...
                ||') or entrea=1 and total_h>0 and total_m>0 and informado(nombrer) or entrea>2',
        ...
        (xoperativo, 'compl_S1_P','', xcon_rel,
            'informado(p4) and informado(edad) and edad>=0 and (edad<14 or informado(p5))',
        ...
        (xoperativo, 'compl_I1','', xcon_rel,
           --bloque salud es el ultimo bloque y es para todos
            'informado(sn1_5)',
       ...
       (xoperativo, 'compl_A1_faltante','entrea<>2', xcon_rel,
            'total_h = dbo.cant_a1(enc) and dbo.cant_a1(enc)>0',
