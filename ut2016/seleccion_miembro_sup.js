"use strict";
var version_js_seleccion_miembro_sup='v 3.00';
...
window.addEventListener('load',function(){
    if(document.getElementById('var_sut_tp') && operativo_actual=='ut2016'){
...
function seleccionar_miembro_sup(solo_controla,este){
    ...
    if(solo_controla){
        ...
        if(grabar_si_es_necesario_o_seguir()){
            setTimeout(function(){
                ir_a_url('ut2016.php?hacer=desplegar_formulario&todo={"tra_ope":"ut2016","tra_for":"SUP","tra_mat":""}');
            },200);
        }
    }
}
