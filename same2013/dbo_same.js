var dbo={
    ...
    p5bfamiliar:function(encues, nhogar, respond){
        ...
        var pk_este=cambiandole(pk_ud,{tra_for:'SM1', tra_mat:'P', tra_enc:encues, tra_hog:nhogar, tra_mie:respond}); // queda:mie es una dbo
    ...
    existemiembro:function(encues, nhogar, P6_a){
        ...
        var pk_este=cambiandole(pk_ud,{tra_for:'SM1', tra_mat:'P', tra_enc:encues, tra_hog:nhogar, tra_mie:P6_a}); // queda:mie es una dbo
        var ud_este=otras_rta[JSON.stringify(pk_este)];
        if (ud_este || ud_este!=undefined){
            return 1;
        }else{
    ...
    existejefe:function(encues, nhogar){
        var nro_mie = 1;
        var pk_este=cambiandole(pk_ud,{tra_for:'SM1', tra_mat:'P', tra_enc:encues, tra_hog:nhogar, tra_mie:nro_mie});
        var ud_este = otras_rta[JSON.stringify(pk_este)];
        while(ud_este || ud_este!=undefined){
            ...
            nro_mie++;
            pk_este = pk_este=cambiandole(pk_ud, {tra_for:'SM1', tra_mat:'P', tra_enc:encues, tra_hog:nhogar, tra_mie:nro_mie});
    ...
    edadjefe:function(encues, nhogar){
        ...
        var ud_este;
        var pk_este=cambiandole(pk_ud,{tra_for:'SM1', tra_mat:'P', tra_enc:encues, tra_hog:nhogar, tra_mie:nro_mie}); // queda:mie es una dbo
        ud_este=otras_rta[JSON.stringify(pk_este)];
        while (ud_este || ud_este!=undefined){
            if (ud_este.var_p4==1){
    ...
    existeindividual:function(encues, nhogar, nmiembro){
        ...
        var pk_este=cambiandole(pk_ud,{tra_for:'SM1', tra_mat:'P', tra_enc:encues, tra_hog:nhogar, tra_mie:miembro});
        ud_este=otras_rta[JSON.stringify(pk_este)];
        if (ud_este || ud_este!=undefined){
            return 1;
        }else{
    ...
    sumah3:function(encues){
        ...
        var ud_este;
        var rta=0;
        var pk_este=cambiandole(pk_ud,{tra_for:'SM1', tra_mat:'', tra_enc:encues, tra_hog:nhogar, tra_mie:0});
        ud_este=otras_rta[JSON.stringify(pk_este)];
        while (ud_este || ud_este!=undefined){
    ...
    anionac:function(encues, nhogar, nmiembro){
        ...
        var pk_este=cambiandole(pk_ud,{tra_for:'SM1', tra_mat:'P', tra_enc:encues, tra_hog:nhogar, tra_mie:nmiembro}); // queda:mie es una dbo
        var ud_este=otras_rta[JSON.stringify(pk_este)];
        if (ud_este || ud_este!=undefined){
            var fecha=new Array();
    ...
    edad_a_la_fecha:function(f_nac_o, f_realiz_o){
        ...
        var ud_este;
        if(!f_realiz_o){
            var pk_este=cambiandole(pk_ud,{tra_for:'SM1', tra_mat:'', tra_mie:0}); 
            ud_este=otras_rta[JSON.stringify(pk_este)];
    ...
    sexojefe:function(p_enc, p_hog){
        var nro_mie=1; // queda:mie es una dbo
        var ud_este;
        var pk_este=cambiandole(pk_ud,{tra_for:'SM1', tra_mat:'P', tra_enc:p_enc, tra_hog:p_hog, tra_mie:nro_mie}); // queda:mie es una dbo
        ud_este=otras_rta[JSON.stringify(pk_este)];
        while (ud_este || ud_este!=undefined){
            if (ud_este.var_p4==1){
    ...
    total_hogares:function(p_enc){
        var nro_hog=1; 
        var ud_este;
        var pk_este=cambiandole(pk_ud,{tra_for:'SM1', tra_mat:'', tra_enc:p_enc, tra_hog:nro_hog}); 
        ud_este=otras_rta[JSON.stringify(pk_este)];
        while (ud_este || ud_este!=undefined){
            nro_hog++;
    ...
    cantex:function(p_enc, p_hog){
        var nro_exm=1; 
        var ud_este;
        var pk_este=cambiandole(pk_ud,{tra_for:'SM1', tra_mat:'X', tra_enc:p_enc, tra_hog:p_hog, tra_mie:0, tra_exm:nro_exm}); 
        ud_este=otras_rta[JSON.stringify(pk_este)];
        while (ud_este || ud_este!=undefined){
            nro_exm++;
