...
Promises.start(function(){
    ...
    */
    ...
    app.get('/persona/load',function(req,res){
        ...
        // probar con localhost:12348/persona/load?con_con=71184210
        clientDb.query('select * from encu.consistencias where con_con = $1',[params.con_con]).fetchOneRowIfExists().then(function(result){
    ...
    app.get('/persona/siguiente',function(req,res){
        var params=req.query;
        // probar con localhost:12348/persona/siguiente?con_con=71184210
        clientDb.query('select * from encu.consistencias where con_con > $1 order by con_con limit 1',[params.con_con]).fetchOneRowIfExists().then(function(result){
            res.send(JSON.stringify(result.row));
        }).catch(function(err){
    ...
    app.get('/persona/bulkload',function(req,res){
        var params=req.query;
        clientDb.query("select * from encu.consistencias where con_tipo in ('Conceptual','Revisar','Completitud') and con_con <= $1",[params.con_con]).fetchAll().then(function(result){
    ...
    app.get('/persona/anterior',function(req,res){
        var params=req.query;
        // probar con localhost:12348/persona/anterior?con_con=71184210
        clientDb.query('select * from encu.consistencias where con_con < $1 order by con_con desc limit 1',[params.con_con]).fetchOneRowIfExists().then(function(result){
            res.send(JSON.stringify(result.row));
        }).catch(function(err){
    ...
    app.get('/persona/primero',function(req,res){
        ...
        clientDb.query('select * from encu.consistencias order by con_con limit 1',null).fetchOneRowIfExists().then(function(result){
            res.send(JSON.stringify(result.row));
        }).catch(function(err){
    ...
    app.get('/persona/ultimo',function(req,res){
        ...
        clientDb.query('select * from encu.consistencias order by con_con desc limit 1',null).fetchOneRowIfExists().then(function(result){
            res.send(JSON.stringify(result.row));
        }).catch(function(err){
