...
select dbo.ope_actual(), var_for, var_mat,  'p5b',  'P5B', var_texto, var_aclaracion, 
            ...
            var_advertencia_inf, var_destino_nsnc, var_calculada, var_tlg
            from encu.variables 
            where var_ope = 'eah2025' and var_var = 'tp5b';
            

select * from encu.con_var where convar_ope = 'eah2025' and convar_var = 'tp5b';
--Si esta en la tabla con_var, borrar los registros:

--delete from encu.con_var where convar_ope = 'eah2025' and convar_var = 'tp5b';
...
delete from encu.respuestas where res_ope='eah2025' and res_for='S1'  and res_mat='P' and res_var='p5b';
update encu.respuestas set res_var='p5b' where res_ope='eah2025' and res_for='S1' and res_mat='P' and res_var='tp5b';
--Cambiar en tabla saltos sal_var 'tp5b' por 'p5b':
--update encu.saltos set sal_var = 'p5b' where sal_ope = 'eah2025' and sal_var = 'tp5b'; --no hay
--Eliminar la variable original:

delete from encu.variables where var_ope = 'eah2025' and var_var = 'tp5b';
