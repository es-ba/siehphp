...
BEGIN 
    ...
    INSERT INTO encu.consistencias( con_ope,con_con,con_precondicion,con_rel,
        ...
        values( 'eah2014', 'flujo_f_f0', 'hog>1', '=>',
    ...
    r_saltadas=encu.variables_saltadas('eah2014', 'respondi', 'e1' );
    ...
    INSERT INTO encu.consistencias( con_ope,con_con,con_precondicion,con_rel,
                ...
                con_activa, con_explicacion, con_tipo, con_falsos_positivos,
                con_importancia, con_momento, con_grupo, con_gravedad, con_tlg)
        values( 'eah2014', 'flujo_f_f2', 'edad<3', '=>',
            'e1 is null',
    ...
    INSERT INTO encu.consistencias( con_ope,con_con,con_precondicion,con_rel,
            ...
            con_activa, con_explicacion, con_tipo, con_falsos_positivos,
            con_importancia, con_momento, con_grupo, con_gravedad, con_tlg)
        values( 'eah2014', 'flujo_f_f3', 'edad<14 or sexo=1', '=>',
    ...
    INSERT INTO encu.consistencias( con_ope,con_con,con_precondicion,con_rel,
            ...
            con_activa, con_explicacion, con_tipo, con_falsos_positivos,
            con_importancia, con_momento, con_grupo, con_gravedad, con_tlg)
        values( 'eah2014', 'flujo_fv_f0', 'hog>1', '=>',
            'informado(h1)',
    ...
    INSERT INTO encu.consistencias( con_ope,con_con,con_precondicion,con_rel,
                ...
                con_activa, con_explicacion, con_tipo, con_falsos_positivos,
                con_importancia, con_momento, con_grupo, con_gravedad, con_tlg)
        values( 'eah2014', 'flujo_fv_f2', 'edad<3', '=>',
            'informado(e2)',
    ...
    INSERT INTO encu.consistencias( con_ope,con_con,con_precondicion,con_rel,
            ...
            con_activa, con_explicacion, con_tipo, con_falsos_positivos,
            con_importancia, con_momento, con_grupo, con_gravedad, con_tlg)
        values( 'eah2014', 'flujo_f_v_f0', 'hog=1', '=>',
            'informado(v2)',
    ...
    INSERT INTO encu.consistencias( con_ope,con_con,con_precondicion,con_rel,
                ...
                con_activa, con_explicacion, con_tipo, con_falsos_positivos,
                con_importancia, con_momento, con_grupo, con_gravedad, con_tlg)
        values( 'eah2014', 'flujo_f_v_f1', 'edad>=10', '=>',
            'informado(t1)',
   ...
   INSERT INTO encu.consistencias( con_ope,con_con,con_precondicion,con_rel,
                ...
                con_activa, con_explicacion, con_tipo, con_falsos_positivos,
                con_importancia, con_momento, con_grupo, con_gravedad, con_tlg)
        values( 'eah2014', 'flujo_f_v_f2', 'edad>=3', '=>',
            'informado(e1)',
   ...
   INSERT INTO encu.consistencias( con_ope,con_con,con_precondicion,con_rel,
                ...
                con_activa, con_explicacion, con_tipo, con_falsos_positivos,
                con_importancia, con_momento, con_grupo, con_gravedad, con_tlg)
        values( 'eah2014', 'flujo_f_v_f3', 'edad>=14 and sexo=2', '=>',
            'informado(s28)',
