...
as $$ select regexp_replace(regexp_replace(regexp_replace(regexp_replace(regexp_replace(regexp_replace(regexp_replace($1,
                 '(?!\mAND\M)(?!\mOR\M)(?!\mNOT\M)(?!\mIS\M)(?!\mNULL\M)(?!\mIN\M)(?!\mCASE\M)(?!\mWHEN\M)(?!\mTHEN\M)(?!\mELSE\M)(?!\mEND\M)(?!\mTRUE\M)(?!\mFALSE\M)(?!\mEXISTS\M)(?!\mDISTINCT\M)(?!\mFROM\M)(?!\mBETWEEN\M)((\m[a-z][a-z0-9_.]*?\M)|\$\$[^$]*?\$\$|"@[^"]*?@"\()(?!\.)(?!\s*\()',
                 '¬¬¬¬1234¬¬¬¬\1¬¬¬¬4321¬¬¬¬','ig'),
                 '¬¬¬¬1234¬¬¬¬(\$\$.*?\$\$)¬¬¬¬4321¬¬¬¬','\1::text','ig'),
                 '::¬¬¬¬1234¬¬¬¬(.*?)¬¬¬¬4321¬¬¬¬','::\1','ig'),
                 '¬¬¬¬1234¬¬¬¬(\W.*?)¬¬¬¬4321¬¬¬¬','\1','ig'),
