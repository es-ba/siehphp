...
(select  'ebcp2014', 'TEM', '', tem_enc, 0,0,0, true, NULL, NULL, NULL, NULL, 1 from encu.tem);
...
update encu.respuestas set res_valor=res_valor where res_var='estado' and res_ope='ebcp2014';

--select pla_tlg, pla_estado, * from encu.plana_tem_
...
-- Function: encu.respuestas_sinc_tem_trg()

-- DROP FUNCTION encu.respuestas_sinc_tem_trg();
...
-- Trigger: respuestas_sinc_tem_trg on encu.respuestas

-- DROP TRIGGER respuestas_sinc_tem_trg ON encu.respuestas;
