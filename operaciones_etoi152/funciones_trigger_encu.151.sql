...
-- Started on 2015-03-12 14:14:48
--

SET search_path = encu, pg_catalog, comun, dbo;

--
-- TOC entry 468 (class 1255 OID 115422)
...
DECLARE
  ...
  v_obs_historico encu.plana_tem_.pla_obs_historico%type; /*G*/
  ...
  then
    if new.res_var='verificado_enc' and new.res_valor::integer<>2 then
        ...
        if (v_rea_enc = 1 or dbo.norea_supervisable(v_norea_enc)) and v_dominio=3 then
            if v_calculo_enc = 1 and coalesce(v_hog_tot,0)<=1 then
                v_aux_aleat_enc := '3';
            elsif v_calculo_enc = 0 and v_rea_enc = 1 and coalesce(v_hog_tot,0)<=1 then
                v_aux_aleat_enc='4';
            else
    ...
    if v_estado_final is null and (((((v_hog_tot>1 and (v_hog_tot=v_hog_pre))/* OR v_norea<70*/) AND v_norea is distinct from 10 AND v_norea is distinct from 18 AND v_norea is distinct from 61) OR ((v_rea=3 OR NOT dbo.norea_recuperable(v_norea_recu) ) AND coalesce(v_sup_dirigida, v_sup_aleat)=3)) AND v_verificado_recu<>0) then v_estado_final:=50; end if; /*G:E*/
...
--
-- TOC entry 469 (class 1255 OID 115425)
...
CREATE OR REPLACE FUNCTION calculo_variables_calculadas_i1__trg() RETURNS trigger
    ...
    v_movil text;
    BEGIN
     SELECT pla_v2_esp,pla_v2,pla_v4
       INTO v_v2_esp,v_v2,v_v4
       FROM encu.plana_a1_ a
       WHERE  a.pla_enc = new.pla_enc and a.pla_hog=1 and a.pla_mie = 0 and a.pla_exm = 0 ;
     SELECT pla_nombre,pla_sexo,pla_f_nac_d,pla_f_nac_m,pla_f_nac_a,pla_edad,pla_p4,pla_p5
       INTO v_nombre,v_sexo,v_f_nac_d,v_f_nac_m,v_f_nac_a,v_edad,v_p4,v_p5
     ...
     SELECT pla_h2,pla_h2_esp,pla_h3,pla_telefono,pla_movil
       INTO v_h2,v_h2_esp,v_h3,v_telefono,v_movil
       FROM encu.plana_a1_ a
       WHERE  a.pla_enc = new.pla_enc and a.pla_hog=new.pla_hog and a.pla_mie = 0 and a.pla_exm = 0 ;

     new.pla_edad_quinque:=case 
        when (v_edad>=0 and v_edad<=4) then 1
        when (v_edad>=5 and v_edad<=9) then 2
        when (v_edad>=10 and v_edad<=14) then 3
        when (v_edad>=15 and v_edad<=19) then 4
        when (v_edad>=20 and v_edad<=24) then 5
        when (v_edad>=25 and v_edad<=29) then 6
        when (v_edad>=30 and v_edad<=34) then 7
        when (v_edad>=35 and v_edad<=39) then 8
        when (v_edad>=40 and v_edad<=44) then 9
        when (v_edad>=45 and v_edad<=49) then 10
        when (v_edad>=50 and v_edad<=54) then 11
        when (v_edad>=55 and v_edad<=59) then 12
        when (v_edad>=60 and v_edad<=64) then 13
        when (v_edad>=65 and v_edad<=69) then 14
        when (v_edad>=70 and v_edad<=74) then 15
        when (v_edad>=75 and v_edad<=79) then 16
        when (v_edad>=80) then 17
         else null end; 
     ...
     new.pla_e_nivel:=case 
        ...
        when (new.pla_e_nivelc=10) then 0
     ...
     new.pla_e_nivel_agr:=case 
        ...
        when (new.pla_e_nivel=0) then 10
         else null end; 

     new.pla_e_aesc:=case 
        when (((v_edad>6 or (v_edad=6 and new.pla_edad_30=6)) and new.pla_e2=3) or (v_edad>=3 and (new.pla_e_nivel=1 or (new.pla_e2=2 and new.pla_e_nivel=2 and new.pla_e14=10)))) then 0
        ...
        when (new.pla_e2=1 and (new.pla_e_nivel=4 or new.pla_e_nivel=2) and new.pla_e8<0 or new.pla_e2=1 and new.pla_e6=12 and new.pla_e8<0 or new.pla_e2=1 and new.pla_e6=13 and new.pla_e8<0 or new.pla_e2=1 and new.pla_e6=14 and new.pla_e8<0 or new.pla_e2=2 and (new.pla_e12=3 or new.pla_e12=5 or new.pla_e12=15) and new.pla_e13=2 and new.pla_e14<0 or new.pla_e2=2 and new.pla_e12=4 and new.pla_e13=2 and new.pla_e14<0 or new.pla_e2=2 and (new.pla_e12=7 or new.pla_e12=10) and new.pla_e13=2 and new.pla_e14<0 or new.pla_e2=2 and new.pla_e12=11 and new.pla_e13=2 and new.pla_e14<0 or new.pla_e2=2 and new.pla_e12=12 and new.pla_e13=2 and new.pla_e14<0 or new.pla_e2=2 and new.pla_e12=13 and new.pla_e13=2 and new.pla_e14<0 or new.pla_e2=2 and new.pla_e12=14 and new.pla_e13=2 and new.pla_e14<0 or new.pla_e2=2 and new.pla_e12<0 or new.pla_e2=2 and new.pla_e12>2 and new.pla_e13<0 and new.pla_e14<0 or new.pla_e2=2 and new.pla_e12<0 or new.pla_e6=6 or new.pla_e12=6 or new.pla_e2<0) then 99
     ...
     new.pla_edad_30:=case 
        when (negado(informado(fechadma(boolint(v_f_nac_d>0 and v_f_nac_d<=31,15,v_f_nac_d) , v_f_nac_m, v_f_nac_a)))) then 999
        when (dbo.texto_a_fecha(fechadma(boolint(v_f_nac_d>0 and v_f_nac_d<=31,15,v_f_nac_d), v_f_nac_m, v_f_nac_a)) > dbo.texto_a_fecha(dbo.fecha_30junio())) then 888
        when (true) then dbo.edad_a_la_fecha(fechadma(boolint(v_f_nac_d>0 and v_f_nac_d<=31,15,v_f_nac_d), v_f_nac_m, v_f_nac_a),dbo.fecha_30junio())
         else null end; 
     ...
     new.pla_tsemrefop:=case 
        when (new.pla_cond_activ=1 and (new.pla_t1=1 or new.pla_t2=1) and (enrango(new.pla_t31_l,1,24)=1 or enrango(new.pla_t31_ma,1,24)=1 or enrango(new.pla_t31_mi,1,24)=1 or enrango(new.pla_t31_j,1,24)=1 or enrango(new.pla_t31_v,1,24)=1 or enrango(new.pla_t31_s,1,24)=1 or enrango(new.pla_t31_d,1,24)=1)) then 1
        when (new.pla_cond_activ=1 and new.pla_t1=2 and new.pla_t2=2 or new.pla_cond_activ=1 and (new.pla_t1=1 or new.pla_t2=1) and negado(enrango(new.pla_t31_l,1,24)=1 or enrango(new.pla_t31_ma,1,24)=1 or enrango(new.pla_t31_mi,1,24)=1 or enrango(new.pla_t31_j,1,24)=1 or enrango(new.pla_t31_v,1,24)=1 or enrango(new.pla_t31_s,1,24)=1 or enrango(new.pla_t31_d,1,24)=1)) then 2
         else null end; 

     new.pla_t_diastra1p:=case 
        when (true) then (enrango(new.pla_t31_d,1,24))+(enrango(new.pla_t31_l,1,24))+(enrango(new.pla_t31_ma,1,24))+(enrango(new.pla_t31_mi,1,24))+(enrango(new.pla_t31_j,1,24))+(enrango(new.pla_t31_v,1,24))+(enrango(new.pla_t31_s,1,24))
         else null end; 

     new.pla_t_diastra2p:=case 
        when (true) then (enrango(new.pla_t32_d,1,24))+(enrango(new.pla_t32_l,1,24))+(enrango(new.pla_t32_ma,1,24))+(enrango(new.pla_t32_mi,1,24))+(enrango(new.pla_t32_j,1,24))+(enrango(new.pla_t32_v,1,24))+(enrango(new.pla_t32_s,1,24))

         else null end; 

     new.pla_t_diasnotr1p:=case 
        when (true) then (enrango(new.pla_t31_d,33,33))+(enrango(new.pla_t31_l,33,33))+(enrango(new.pla_t31_ma,33,33))+(enrango(new.pla_t31_mi,33,33))+(enrango(new.pla_t31_j,33,33))+(enrango(new.pla_t31_v,33,33))+(enrango(new.pla_t31_s,33,33))
         else null end; 

     new.pla_t_diasnotr2p:=case 
        when (true) then (enrango(new.pla_t32_d,33,33))+(enrango(new.pla_t32_l,33,33))+(enrango(new.pla_t32_ma,33,33))+(enrango(new.pla_t32_mi,33,33))+(enrango(new.pla_t32_j,33,33))+(enrango(new.pla_t32_v,33,33))+(enrango(new.pla_t32_s,33,33))
         else null end; 
     ...
     new.pla_t_categ:=case 
        when (new.pla_cond_activ=1 and (new.pla_t44=-9 or new.pla_t45=-9 or new.pla_t46=-9 or new.pla_t47=-9 or new.pla_t48=-9) and not new.pla_t46=1) then -9
     ...
     new.pla_t51_bis:=case 
        when (new.pla_t51<0) then -9
        when (v_edad<10 or new.pla_cond_activ=2 or new.pla_cond_activ=3 or new.pla_categori<=2 or new.pla_categori>=4) then 0
        when (new.pla_t51=1) then 1
        when (new.pla_t51=2 or (new.pla_categori=3 and (new.pla_t48a=5 or (new.pla_t48a=9 and new.pla_t48b>=1 and new.pla_t48b<=2)))) then 2
        when (new.pla_t51=3 or new.pla_categori=3 and (new.pla_t48a>=1 and new.pla_t48a<=4 or new.pla_t48a=9 and new.pla_t48b>=3 and new.pla_t48b<=6)) then 3
         else null end; 

     new.pla_t51_re:=case 
        when (new.pla_t51_bis=0) then 0
        when (new.pla_t51_bis=1) then 1
        when (new.pla_t51_bis=2 or new.pla_t51_bis=3) then 2
        when (new.pla_t51_bis<0) then 9
         else null end; 
     ...
     new.pla_categoa:=case 
        when (blanco(new.pla_i20) or new.pla_i20<>1) then 0
        when ((new.pla_i20a>0 or new.pla_i20a<0) and new.pla_i20b=0) then 1
        when ((new.pla_i20b>0 or new.pla_i20b<0) and new.pla_i20a=0) then 2
        when (new.pla_i20=1 and ((new.pla_i20a>0 or new.pla_i20a<0) or (new.pla_i20b>0 or new.pla_i20b<0))) then 3
         else null end; 

     new.pla_categos:=case 
        when (blanco(new.pla_i17) or new.pla_i17<>1) then 0
        when ((new.pla_i17a>0 or new.pla_i17a<0) and new.pla_i17b=0) then 1
        when ((new.pla_i17b>0 or new.pla_i17b<0) and new.pla_i17a=0) then 2
        when (new.pla_i17=1 and ((new.pla_i17a>0 or new.pla_i17a<0) or (new.pla_i17b>0 or new.pla_i17b<0))) then 3
         else null end; 

     new.pla_codi12:=case 
        when (new.pla_i11=1 and new.pla_i12<0) then -9
        when (new.pla_cond_activ<>1 or new.pla_t44=3 or new.pla_t45=1 or new.pla_t45=3 or new.pla_t37sd=1 or new.pla_i10=2 or new.pla_i11<0 and new.pla_i12<0 or new.pla_i11=2) then 0
        when (new.pla_i11=1 and new.pla_i12>0) then 1
        when (new.pla_i11=1 and new.pla_i12=0) then 2
         else null end; 

     new.pla_codi13:=case 
        when ((new.pla_i10=1 or new.pla_i11=2) and new.pla_i13<0) then -9
        when (new.pla_cond_activ<>1 or new.pla_t44=3 or new.pla_t45=1 or new.pla_t45=3 or new.pla_t37sd=1 or new.pla_i10=2) then 0
        when ((new.pla_i10=1 or new.pla_i11=2) and new.pla_i13>0) then 1
        when ((new.pla_i10=1 or new.pla_i11=2) and new.pla_i13=0) then 2
         else null end; 

     new.pla_codi14:=case 
        when (new.pla_i10=2 and new.pla_i14<0) then -9
        when (new.pla_cond_activ<>1 or new.pla_t44=3 or new.pla_t45=1 or new.pla_t45=3 or new.pla_t37sd=1 or new.pla_i10=1) then 0
        when (new.pla_i10=2 and new.pla_i14>0) then 1
        when (new.pla_i10=2 and new.pla_i14=0) then 2
         else null end; 

     new.pla_codi17a:=case 
        when (new.pla_i17a<0) then -9
        when (blanco(new.pla_i17) or new.pla_i17<>1) then 0
        when (new.pla_i17a>0) then 1
        when (new.pla_i17a=0) then 2
         else null end; 

     new.pla_codi17b:=case 
        when (new.pla_i17b<0) then -9
        when (blanco(new.pla_i17) or new.pla_i17<>1) then 0
        when (new.pla_i17b>0) then 1
        when (new.pla_i17b=0) then 2
         else null end; 

     new.pla_codi20a:=case 
        when (new.pla_i20a<0) then -9
        when (blanco(new.pla_i20) or new.pla_i20<>1) then 0
        when (new.pla_i20a>0) then 1
        when (new.pla_i20a=0) then 2
         else null end; 

     new.pla_codi20b:=case 
        when (new.pla_i20b<0) then -9
        when (blanco(new.pla_i20) or new.pla_i20<>1) then 0
        when (new.pla_i20b>0) then 1
        when (new.pla_i20b=0) then 2
         else null end; 

     new.pla_codioa:=case 
        when (new.pla_ioa<0) then -9
        when (v_edad<10 or new.pla_i20<0) then 0
        when (new.pla_ioa>0) then 1
        when (new.pla_i20=2) then 2
         else null end; 

     new.pla_codiop:=case 
        when (new.pla_cond_activ=1 and new.pla_iop<0) then -9
        when (new.pla_cond_activ<>1 or new.pla_i1<0) then 0
        when (new.pla_cond_activ=1 and new.pla_iop>0) then 1
        when (new.pla_cond_activ=1 and new.pla_iop=0) then 2
         else null end; 

     new.pla_codiop_as:=case 
        when (new.pla_codiop=-9 and new.pla_categori=3) then -9
        when (new.pla_codiop=0 or new.pla_categori<>3) then 0
        when (new.pla_codiop=1 and new.pla_categori=3) then 1
        when (new.pla_codiop=2 and new.pla_categori=3) then 2
         else null end; 

     new.pla_codiop_ind:=case 
        when (new.pla_codiop=-9 and (new.pla_categori=1 or new.pla_categori=2)) then -9
        when (new.pla_codiop=0 or negado(new.pla_categori=1 or new.pla_categori=2)) then 0
        when (new.pla_codiop=1 and (new.pla_categori=1 or new.pla_categori=2)) then 1
        when (new.pla_codiop=2 and (new.pla_categori=1 or new.pla_categori=2)) then 2
         else null end; 

     new.pla_codiop_neto:=case 
        when (new.pla_cond_activ=1 and new.pla_iop_neto<0) then -9
        when (new.pla_cond_activ<>1 or new.pla_i1<0) then 0
        when (new.pla_cond_activ=1 and new.pla_iop_neto>0) then 1
        when (new.pla_cond_activ=1 and new.pla_iop_neto=0) then 2
         else null end; 

     new.pla_codiop_neto_as:=case 
        when (new.pla_codiop_neto=-9 and new.pla_categori=3) then -9
        when (new.pla_codiop_neto=0 or new.pla_categori<>3) then 0
        when (new.pla_codiop_neto=1 and new.pla_categori=3) then 1
        when (new.pla_codiop_neto=2 and new.pla_categori=3) then 2
         else null end; 

     new.pla_codioph:=case 
        when (new.pla_cond_activ=1 and new.pla_ioph<0) then -9
        when (new.pla_cond_activ<>1 or new.pla_i1<0 or new.pla_i1=2 and new.pla_i4<0 and blanco(new.pla_i5)) then 0
        when (new.pla_cond_activ=1 and new.pla_ioph>0) then 1
        when (new.pla_cond_activ=1 and new.pla_ioph=0) then 2
         else null end; 

     new.pla_codioph_as:=case 
        when (new.pla_codioph=-9 and new.pla_categori=3) then -9
        when (new.pla_codioph=0 or new.pla_categori<>3) then 0
        when (new.pla_codioph=1 and new.pla_categori=3) then 1
        when (new.pla_codioph=2 and new.pla_categori=3) then 2
         else null end; 

     new.pla_codioph_neto:=case 
        when (new.pla_cond_activ=1 and new.pla_ioph_neto<0) then -9
        when (new.pla_cond_activ<>1 or new.pla_i1<0 or new.pla_i1=2 and new.pla_i4<0 and blanco(new.pla_i5)) then 0
        when (new.pla_cond_activ=1 and new.pla_ioph_neto>0) then 1
        when (new.pla_cond_activ=1 and new.pla_ioph_neto=0) then 2
         else null end; 

     new.pla_codioph_neto_as:=case 
        when (new.pla_codioph_neto=-9 and new.pla_categori=3) then -9
        when (new.pla_codioph_neto=0 or new.pla_categori<>3) then 0
        when (new.pla_codioph_neto=1 and new.pla_categori=3) then 1
        when (new.pla_codioph_neto=2 and new.pla_categori=3) then 2
         else null end; 

     new.pla_codiopnectrolc:=case 
        when (new.pla_codiop<>new.pla_ctrol_codiop) then 1
         else null end; 

     new.pla_codios:=case 
        when (new.pla_ios<0) then -9
        when (new.pla_cond_activ<>1 or new.pla_t30=1 or new.pla_t28=1 or new.pla_i17<0 or (new.pla_t30<0 or new.pla_t28<0) and blanco(new.pla_i17)) then 0
        when (new.pla_ios>0) then 1
        when (new.pla_i17=2) then 2
         else null end; 

     new.pla_copiacomuna:=case 
        when (v_comuna>=0) then v_comuna
         else null end; 

     new.pla_copiaedad:=case 
        when (v_edad>=0) then v_edad
         else null end; 

     new.pla_ctrol_codiop:=case 
        when (new.pla_i1=1 and new.pla_i7a<0 or new.pla_i12<0 and new.pla_i13<=0 or new.pla_i12<=0 and new.pla_i13<0 or blanco(new.pla_i12) and new.pla_i13<0 or blanco(new.pla_i13) and new.pla_i12<0 or new.pla_i14<0) then -9
        when (new.pla_cond_activ<>1 or new.pla_i1<0) then 0
        when (new.pla_i1=1 and new.pla_i7a>0 or new.pla_i12>0 and new.pla_i13>=0 or new.pla_i12>=0 and new.pla_i13>0 or new.pla_i12>0 and new.pla_i13<0 or new.pla_i12<0 and new.pla_i13>0 or blanco(new.pla_i12) and new.pla_i13>0 or blanco(new.pla_i13) and new.pla_i12>0 or new.pla_i14>0) then 1
        when (new.pla_t45=3 or new.pla_i1=2 or new.pla_i12=0 and new.pla_i13=0 or blanco(new.pla_i12) and new.pla_i13=0 or blanco(new.pla_i13) and new.pla_i12=0 or new.pla_i14=0) then 2
         else null end; 

     new.pla_ctrol_codioph:=case 
        when (new.pla_i1=1 and new.pla_i7a<0 or new.pla_i4=1 and new.pla_i7a<0 or (new.pla_i4=2 or new.pla_i4=3 or new.pla_i4<0) and new.pla_i5<0 or new.pla_i12<0 and new.pla_i13<=0 or new.pla_i12<=0 and new.pla_i13<0 or blanco(new.pla_i12) and new.pla_i13<0 or blanco(new.pla_i13) and new.pla_i12<0 or new.pla_i14<0) then -9
        when (new.pla_cond_activ<>1 or new.pla_i1<0 or new.pla_i1=2 and new.pla_i4<0 and blanco(new.pla_i5)) then 0
        when (new.pla_i1=1 and new.pla_i7a>0 or new.pla_i4=1 and new.pla_i7a>0 or (new.pla_i4=2 or new.pla_i4=3 or new.pla_i4<0) and new.pla_i5>0 or new.pla_i12>0 and new.pla_i13>=0 or new.pla_i12>=0 and new.pla_i13>0 or new.pla_i12>0 and new.pla_i13<0 or new.pla_i12<0 and new.pla_i13>0 or blanco(new.pla_i12) and new.pla_i13>0 or blanco(new.pla_i13) and new.pla_i12>0 or new.pla_i14>0) then 1
        when (new.pla_t45=3 or new.pla_i1=2 and (new.pla_i4=4 or new.pla_i4=5) or new.pla_i12=0 and new.pla_i13=0 or blanco(new.pla_i12) and new.pla_i13=0 or blanco(new.pla_i13) and new.pla_i12=0 or new.pla_i14=0) then 2
         else null end; 
     ...
     new.pla_ioa:=case 
        when (v_edad<10 or new.pla_i20=2) then 0
        when (new.pla_i20=1 and (new.pla_i20a<0 or new.pla_i20a>0) and new.pla_i20b=0) then new.pla_i20a
        when (new.pla_i20=1 and (new.pla_i20b<0 or new.pla_i20b>0) and new.pla_i20a=0) then new.pla_i20b
        when (new.pla_i20=1 and new.pla_i20a>0 and new.pla_i20b>0) then new.pla_i20b+new.pla_i20a
        when (new.pla_i20=1 and (new.pla_i20a<0 and new.pla_i20b>0 or new.pla_i20b<0 and new.pla_i20a>0 or new.pla_i20a<0 and new.pla_i20b<0)) then -9
         else null end; 

     new.pla_ioa_ctrol:=case 
        when (v_edad<10) then 0
        when (new.pla_i20=1 and (new.pla_i20a<0 or new.pla_i20a>0) and new.pla_i20b=0) then 1
        when (new.pla_i20=1 and (new.pla_i20b<0 or new.pla_i20b>0) and new.pla_i20a=0) then 2
        when (new.pla_i20=1 and new.pla_i20a>0 and new.pla_i20b>0) then 3
        when (new.pla_i20=1 and (new.pla_i20a<0 and new.pla_i20b>0 or new.pla_i20b<0 and new.pla_i20a>0 or new.pla_i20a<0 and new.pla_i20b<0)) then 4
        when (new.pla_i20=2) then 5
         else null end; 

     new.pla_iop:=case 
        when (new.pla_cond_activ<>1) then 0
        when (new.pla_t45=3) then 0
        when (new.pla_i1=1) then new.pla_i7a
        when (new.pla_i1=2 and new.pla_i4<=3) then 0
        when (new.pla_i1=2 and (new.pla_i4=4 or new.pla_i4=5)) then 0
        when (new.pla_i1<0) then -9
        when (new.pla_i10=2 or new.pla_i10<0 and informado(new.pla_i14)) then new.pla_i14
        when ((new.pla_i11=1 or (new.pla_i11<0 and informado(new.pla_i12) and informado(new.pla_i13))) and new.pla_i12>=0 and new.pla_i13>=0) then new.pla_i12+new.pla_i13
        when ((new.pla_i11=1 or (new.pla_i11<0 and informado(new.pla_i12) and informado(new.pla_i13))) and new.pla_i12>0 and new.pla_i13<0) then new.pla_i12
        when ((new.pla_i11=1 or (new.pla_i11<0 and informado(new.pla_i12) and informado(new.pla_i13))) and new.pla_i13>0 and new.pla_i12<0) then new.pla_i13
        when ((new.pla_i11=1 or (new.pla_i11<0 and informado(new.pla_i12) and informado(new.pla_i13))) and (new.pla_i12<0 and new.pla_i13<=0 or new.pla_i12<=0 and new.pla_i13<0)) then -9
        when (new.pla_i11=2 or new.pla_i11<0 and informado(new.pla_i13) and blanco(new.pla_i12)) then new.pla_i13
         else null end; 

     new.pla_iop_as:=case 
        when (new.pla_cond_activ>1 or new.pla_cond_activ=1 and new.pla_categori<>3) then 0
        when (new.pla_categori=3) then new.pla_iop
         else null end; 

     new.pla_iop_ctrol:=case 
        when (new.pla_cond_activ<>1) then 0
        when (new.pla_t45=3) then 1
        when (new.pla_i1=1) then 2
        when (new.pla_i1=2 and new.pla_i4<=3) then 3
        when (new.pla_i1=2 and (new.pla_i4=4 or new.pla_i4=5)) then 4
        when (new.pla_i1<0 and (blanco(new.pla_i5) and (blanco(new.pla_i7a) or new.pla_i7a<0) or new.pla_i5<0 and new.pla_i7a<0)) then 5
        when (new.pla_i10=2 or new.pla_i10<0 and informado(new.pla_i14)) then 6
        when ((new.pla_i11=1 or (new.pla_i11<0 and informado(new.pla_i12) and informado(new.pla_i13))) and new.pla_i12>=0 and new.pla_i13>=0) then 7
        when ((new.pla_i11=1 or (new.pla_i11<0 and informado(new.pla_i12) and informado(new.pla_i13))) and new.pla_i12>0 and new.pla_i13<0) then 8
        when ((new.pla_i11=1 or (new.pla_i11<0 and informado(new.pla_i12) and informado(new.pla_i13))) and new.pla_i13>0 and new.pla_i12<0) then 9
        when ((new.pla_i11=1 or (new.pla_i11<0 and informado(new.pla_i12) and informado(new.pla_i13))) and (new.pla_i12<0 and new.pla_i13<=0 or new.pla_i12<=0 and new.pla_i13<0)) then 10
        when (new.pla_i11=2 or new.pla_i11<0 and informado(new.pla_i13) and blanco(new.pla_i12)) then 11
         else null end; 

     new.pla_iop_ind:=case 
        when (new.pla_cond_activ>1 or new.pla_cond_activ=1 and negado(new.pla_categori=1 or new.pla_categori=2)) then 0
        when (new.pla_categori=1 or new.pla_categori=2) then new.pla_iop
         else null end; 

     new.pla_iop_net_ctrol:=case 
        when (blanco(new.pla_i7c) and (blanco(new.pla_i6_3) or new.pla_i6_3<0 or new.pla_i6_3=2) or informado(new.pla_i7c) and new.pla_i1=2) then 0
        when (new.pla_i1=1 and new.pla_i7c>0 and new.pla_i7a>0) then 1
        when (new.pla_i1=1 and new.pla_i7a<0) then 2
        when (new.pla_i1=1 and new.pla_i7a>0 and new.pla_i7c<0) then 3
         else null end; 

     new.pla_iop_neto:=case 
        when (blanco(new.pla_i7c) and (blanco(new.pla_i6_3) or new.pla_i6_3<0 or new.pla_i6_3=2) or informado(new.pla_i7c) and new.pla_i1=2) then new.pla_iop
        when (new.pla_i1=1 and new.pla_i7c>0 and new.pla_i7a>0) then new.pla_iop-new.pla_i7c
        when (new.pla_i1=1 and new.pla_i7a<0) then new.pla_iop
        when (new.pla_i1=1 and new.pla_i7a>0 and new.pla_i7c<0) then -9
         else null end; 

     new.pla_iop_neto_as:=case 
        when (new.pla_cond_activ>1 or new.pla_cond_activ=1 and new.pla_categori<>3) then 0
        when (new.pla_categori=3) then new.pla_iop_neto
         else null end; 

     new.pla_ioph:=case 
        when (new.pla_cond_activ<>1) then 0
        when (new.pla_t45=3) then 0
        when (new.pla_i1=1 or new.pla_i1=2 and new.pla_i4=1 or new.pla_i1<0 and informado(new.pla_i7a)) then new.pla_i7a
        when (new.pla_i1=2 and (new.pla_i4=2 or new.pla_i4=3) or new.pla_i4<0 and informado(new.pla_i5)) then new.pla_i5
        when (new.pla_i1=2 and (new.pla_i4=4 or new.pla_i4=5)) then 0
        when (new.pla_i1<0 or new.pla_i1=2 and new.pla_i4<0 and blanco(new.pla_i5)) then -9
        when (new.pla_i10=2 or new.pla_i10<0 and informado(new.pla_i14)) then new.pla_i14
        when ((new.pla_i11=1 or (new.pla_i11<0 and informado(new.pla_i12) and informado(new.pla_i13))) and new.pla_i12>=0 and new.pla_i13>=0) then new.pla_i12+new.pla_i13
        when ((new.pla_i11=1 or (new.pla_i11<0 and informado(new.pla_i12) and informado(new.pla_i13))) and new.pla_i12>0 and new.pla_i13<0) then new.pla_i12
        when ((new.pla_i11=1 or (new.pla_i11<0 and informado(new.pla_i12) and informado(new.pla_i13))) and new.pla_i13>0 and new.pla_i12<0) then new.pla_i13
     ...
     new.pla_ioph_as:=case 
        when (new.pla_cond_activ>1 or new.pla_cond_activ=1 and new.pla_categori<>3) then 0
        when (new.pla_categori=3) then new.pla_ioph
         else null end; 

     new.pla_ioph_ctrol:=case 
        when (new.pla_cond_activ<>1) then 0
        when (new.pla_t45=3) then 1
        when (new.pla_i1=1 or new.pla_i1=2 and new.pla_i4=1 or new.pla_i1<0 and informado(new.pla_i7a)) then 2
        when (new.pla_i1=2 and (new.pla_i4=2 or new.pla_i4=3) or new.pla_i4<0 and informado(new.pla_i5)) then 3
        when (new.pla_i1=2 and (new.pla_i4=4 or new.pla_i4=5)) then 4
        when (new.pla_i1<0 or new.pla_i1=2 and new.pla_i4<0 and blanco(new.pla_i5)) then 5
        when (new.pla_i10=2 or new.pla_i10<0 and informado(new.pla_i14)) then 6
        when ((new.pla_i11=1 or (new.pla_i11<0 and informado(new.pla_i12) and informado(new.pla_i13))) and new.pla_i12>=0 and new.pla_i13>=0) then 7
        when ((new.pla_i11=1 or (new.pla_i11<0 and informado(new.pla_i12) and informado(new.pla_i13))) and new.pla_i12>0 and new.pla_i13<0) then 8
        when ((new.pla_i11=1 or (new.pla_i11<0 and informado(new.pla_i12) and informado(new.pla_i13))) and new.pla_i13>0 and new.pla_i12<0) then 9
     ...
     new.pla_ioph_net_ctrol:=case 
        when (new.pla_ioph=new.pla_ioph_neto) then 1
        when (new.pla_i7a>0 and new.pla_i7c<0) then 3
         else null end; 

     new.pla_ioph_neto:=case 
        when (blanco(new.pla_i7c) and (blanco(new.pla_i6_3) or new.pla_i6_3<0 or new.pla_i6_3=2)) then new.pla_ioph
        when (new.pla_i7c>0 and new.pla_i7a>0) then new.pla_ioph-new.pla_i7c
        when (new.pla_i7a<0) then new.pla_ioph
        when (new.pla_i7a>0 and new.pla_i7c<0) then -9
         else null end; 

     new.pla_ioph_neto_as:=case 
        when (new.pla_cond_activ>1 or new.pla_cond_activ=1 and new.pla_categori<>3) then 0
        when (new.pla_categori=3) then new.pla_ioph_neto
         else null end; 

     new.pla_iopneioph:=case 
        when (new.pla_cond_activ<>1) then 0
        when (new.pla_cond_activ=1 and new.pla_iop<>new.pla_ioph) then 1
        when (new.pla_cond_activ=1 and new.pla_iop=new.pla_ioph) then 2
         else null end; 

     new.pla_ios:=case 
        when (new.pla_cond_activ<>1 or new.pla_cond_activ=1 and (new.pla_t30=1 or new.pla_t28=1 or (new.pla_t30<0 or new.pla_t28<0) and blanco(new.pla_i17)) or new.pla_i17=2) then 0
        when (new.pla_i17=1 and (new.pla_i17a<0 or new.pla_i17a>0) and new.pla_i17b=0) then new.pla_i17a
        when (new.pla_i17=1 and (new.pla_i17b<0 or new.pla_i17b>0) and new.pla_i17a=0) then new.pla_i17b
        when (new.pla_i17=1 and new.pla_i17a>0 and new.pla_i17b>0) then new.pla_i17b+new.pla_i17a
        when (new.pla_i17=1 and (new.pla_i17a<0 and new.pla_i17b>0 or new.pla_i17b<0 and new.pla_i17a>0 or new.pla_i17a<0 and new.pla_i17b<0)) then -9
         else null end; 

     new.pla_ios_ctrol:=case 
        when (new.pla_cond_activ<>1 or new.pla_cond_activ=1 and (new.pla_t30=1 or new.pla_t28=1 or (new.pla_t30<0 or new.pla_t28<0) and blanco(new.pla_i17))) then 0
        when (new.pla_i17=1 and (new.pla_i17a<0 or new.pla_i17a>0) and new.pla_i17b=0) then 1
        when (new.pla_i17=1 and (new.pla_i17b<0 or new.pla_i17b>0) and new.pla_i17a=0) then 2
        when (new.pla_i17=1 and new.pla_i17a>0 and new.pla_i17b>0) then 3
        when (new.pla_i17=1 and (new.pla_i17a<0 and new.pla_i17b>0 or new.pla_i17b<0 and new.pla_i17a>0 or new.pla_i17a<0 and new.pla_i17b<0)) then 4
        when (new.pla_i17=2) then 5
         else null end; 

     new.pla_meshst53bis:=case 
        when (new.pla_cond_activ=1 and (new.pla_i1=1 or informado(new.pla_i10)) and (new.pla_t53_bis1_mes<0 or new.pla_t53_bis1_sem<0 or new.pla_t53_bis2<0)) then -9
        when (new.pla_cond_activ<>1 or new.pla_t45=3 or new.pla_i1=2 and new.pla_i4<>1) then 0
        when ((new.pla_t53_bis1=1 or new.pla_t53_bis1=2 or new.pla_t53_bis1<0) and new.pla_t53_bis1_sem>0) then new.pla_t53_bis1_sem*new.pla_t53_bis2*4.3
        when (new.pla_t53_bis1=3 or (new.pla_t53_bis1<0 and informado(new.pla_t53_bis1_mes))) then new.pla_t53_bis1_mes*new.pla_t53_bis2
         else null end; 

     new.pla_rsem_hs_op:=case 
        when (new.pla_cond_activ=1 and new.pla_tsemrefop=1 and new.pla_sem_hs1p=0) then -9
        when (new.pla_cond_activ = 1 and new.pla_tsemrefop = 2) then 0
        when (new.pla_sem_hs1p>=1 and new.pla_sem_hs1p<16) then 1
        when (new.pla_sem_hs1p>=16 and new.pla_sem_hs1p<35) then 2
        when (new.pla_sem_hs1p>=35 and new.pla_sem_hs1p<=45) then 3
        when (new.pla_sem_hs1p>45) then 4
         else null end; 

     new.pla_rsem_hs_os:=case 
        when (new.pla_cond_activ=1 and new.pla_tsemref=1 and new.pla_sem_hs2p=0) then -9
        when (new.pla_cond_activ = 1 and new.pla_tsemref = 2) then 0
        when (new.pla_sem_hs2p>=1 and new.pla_sem_hs2p<16) then 1
        when (new.pla_sem_hs2p>=16 and new.pla_sem_hs2p<35) then 2
        when (new.pla_sem_hs2p>=35 and new.pla_sem_hs2p<=45) then 3
        when (new.pla_sem_hs2p>45) then 4
         else null end; 

     new.pla_rsemhst53:=case 
        when (new.pla_semhst53bis=-9) then -9
        when (new.pla_cond_activ<>1 or new.pla_t45=3 or new.pla_i1=2 and new.pla_i4<>1) then 0
        when (new.pla_semhst53bis<16) then 1
        when (new.pla_semhst53bis>=16 and new.pla_semhst53bis<35) then 2
        when (new.pla_semhst53bis>=35 and new.pla_semhst53bis<=45) then 3
        when (new.pla_semhst53bis>45) then 4
         else null end; 

     new.pla_rsemhst53_2:=case 
        when (new.pla_semhst53bis=-9) then -9
        when (new.pla_cond_activ<>1 or new.pla_t45=3 or new.pla_i1=2 and new.pla_i4<>1) then 0
        when (new.pla_semhst53bis<16) then 1
        when (new.pla_semhst53bis>=16 and new.pla_semhst53bis<26) then 2
        when (new.pla_semhst53bis>=26 and new.pla_semhst53bis<=48) then 3
        when (new.pla_semhst53bis>48) then 4
         else null end; 

     new.pla_semhst53bis:=case 
        when (new.pla_cond_activ=1 and (new.pla_i1=1 or informado(new.pla_i10)) and (new.pla_t53_bis1_mes<0 or new.pla_t53_bis1_sem<0 or new.pla_t53_bis2<0)) then -9
        when (new.pla_cond_activ<>1 or new.pla_t45=3 or new.pla_i1=2 and new.pla_i4<>1) then 0
        when ((new.pla_t53_bis1=1 or new.pla_t53_bis1=2 or new.pla_t53_bis1<0) and new.pla_t53_bis1_sem>0) then new.pla_t53_bis1_sem*new.pla_t53_bis2
        when (new.pla_t53_bis1=3 or (new.pla_t53_bis1<0 and informado(new.pla_t53_bis1_mes))) then round(new.pla_t53_bis1_mes*new.pla_t53_bis2::numeric/4.3,1)
         else null end; 

     new.pla_t_intens2:=case 
        when (new.pla_cond_activ=1 and new.pla_tsemref=1 and new.pla_sem_hs=0) then -9
        when (new.pla_cond_activ = 1 and new.pla_tsemref = 2) then 0
        when (new.pla_sem_hs>=1 and new.pla_sem_hs<16) then 1
        when (new.pla_sem_hs>=16 and new.pla_sem_hs<26) then 2
        when (new.pla_sem_hs>=26 and new.pla_sem_hs<=48) then 3
        when (new.pla_sem_hs>48) then 4
         else null end; 

     new.pla_t40bis:=case 
        when (new.pla_t40a>=1 and new.pla_t40a<9) then new.pla_t40a
        when (new.pla_t40a=9) then new.pla_t40b
         else null end; 

     new.pla_codi3_10x:=case 
        when (v_edad>=10 and new.pla_i3_10=1 and new.pla_i3_10x<0) then -9
        when (v_edad<10 or new.pla_i3_10<0) then 0
        when (v_edad>=10 and new.pla_i3_10=1 and new.pla_i3_10x>0) then 1
        when (v_edad>=10 and new.pla_i3_10=2) then 2
         else null end; 

     new.pla_codi3_11x:=case 
        when (v_edad>=10 and new.pla_i3_11=1 and new.pla_i3_11x<0) then -9
        when (v_edad<10 or new.pla_i3_11<0) then 0
        when (v_edad>=10 and new.pla_i3_11=1 and new.pla_i3_11x>0) then 1
        when (v_edad>=10 and new.pla_i3_11=2) then 2
         else null end; 

     new.pla_codi3_12x:=case 
        when (v_edad>=10 and new.pla_i3_12=1 and new.pla_i3_12x<0) then -9
        when (v_edad<10 or new.pla_i3_12<0) then 0
        when (v_edad>=10 and new.pla_i3_12=1 and new.pla_i3_12x>0) then 1
        when (v_edad>=10 and new.pla_i3_12=2) then 2
         else null end; 

     new.pla_codi3_13x:=case 
        when (v_edad>=10 and new.pla_i3_13=1 and new.pla_i3_13x<0) then -9
        when (v_edad<10 or new.pla_i3_13<0) then 0
        when (v_edad>=10 and new.pla_i3_13=1 and new.pla_i3_13x>0) then 1
        when (v_edad>=10 and new.pla_i3_13=2) then 2
         else null end; 

     new.pla_codi3_1x:=case 
        when (v_edad>=10 and new.pla_i3_1=1 and new.pla_i3_1x<0) then -9
        when (v_edad<10 or new.pla_i3_1<0) then 0
        when (v_edad>=10 and new.pla_i3_1=1 and new.pla_i3_1x>0) then 1
        when (v_edad>=10 and new.pla_i3_1=2) then 2
         else null end; 

     new.pla_codi3_2x:=case 
        when (v_edad>=10 and new.pla_i3_2=1 and new.pla_i3_2x<0) then -9
        when (v_edad<10 or new.pla_i3_2<0) then 0
        when (v_edad>=10 and new.pla_i3_2=1 and new.pla_i3_2x>0) then 1
        when (v_edad>=10 and new.pla_i3_2=2) then 2
         else null end; 

     new.pla_codi3_31x:=case 
        when (v_edad>=10 and new.pla_i3_31=1 and new.pla_i3_31x<0) then -9
        when (v_edad<10 or new.pla_i3_31<0) then 0
        when (v_edad>=10 and new.pla_i3_31=1 and new.pla_i3_31x>0) then 1
        when (v_edad>=10 and new.pla_i3_31=2) then 2
         else null end; 

     new.pla_codi3_3x:=case 
        when (v_edad>=10 and new.pla_i3_3=1 and new.pla_i3_3x<0) then -9
        when (v_edad<10 or new.pla_i3_3<0) then 0
        when (v_edad>=10 and new.pla_i3_3=1 and new.pla_i3_3x>0) then 1
        when (v_edad>=10 and new.pla_i3_3=2) then 2
         else null end; 

     new.pla_codi3_4x:=case 
        when (v_edad>=10 and new.pla_i3_4=1 and new.pla_i3_4x<0) then -9
        when (v_edad<10 or new.pla_i3_4<0) then 0
        when (v_edad>=10 and new.pla_i3_4=1 and new.pla_i3_4x>0) then 1
        when (v_edad>=10 and new.pla_i3_4=2) then 2
         else null end; 

     new.pla_codi3_5x:=case 
        when (v_edad>=10 and new.pla_i3_5=1 and new.pla_i3_5x<0) then -9
        when (v_edad<10 or new.pla_i3_5<0) then 0
        when (v_edad>=10 and new.pla_i3_5=1 and new.pla_i3_5x>0) then 1
        when (v_edad>=10 and new.pla_i3_5=2) then 2
         else null end; 

     new.pla_codi3_6x:=case 
        when (v_edad>=10 and new.pla_i3_6=1 and new.pla_i3_6x<0) then -9
        when (v_edad<10 or new.pla_i3_6<0) then 0
        when (v_edad>=10 and new.pla_i3_6=1 and new.pla_i3_6x>0) then 1
        when (v_edad>=10 and new.pla_i3_6=2) then 2
         else null end; 

     new.pla_codi3_7x:=case 
        when (v_edad>=10 and new.pla_i3_7=1 and new.pla_i3_7x<0) then -9
        when (v_edad<10 or new.pla_i3_7<0) then 0
        when (v_edad>=10 and new.pla_i3_7=1 and new.pla_i3_7x>0) then 1
        when (v_edad>=10 and new.pla_i3_7=2) then 2
         else null end; 

     new.pla_codi3_81x:=case 
        when (v_edad>=10 and new.pla_i3_81=1 and new.pla_i3_81x<0) then -9
        when (v_edad<10 or new.pla_i3_81<0) then 0
        when (v_edad>=10 and new.pla_i3_81=1 and new.pla_i3_81x>0) then 1
        when (v_edad>=10 and new.pla_i3_81=2) then 2
         else null end; 

     new.pla_codi3_82x:=case 
        when (v_edad>=10 and new.pla_i3_82=1 and new.pla_i3_82x<0) then -9
        when (v_edad<10 or new.pla_i3_82<0) then 0
        when (v_edad>=10 and new.pla_i3_82=1 and new.pla_i3_82x>0) then 1
        when (v_edad>=10 and new.pla_i3_82=2) then 2
         else null end; 
     ...
     new.pla_jubilac:=case 
        when (new.pla_t51<0 or new.pla_t48b<0 or new.pla_categori<0) then -9
        when (new.pla_cond_activ=2 or new.pla_cond_activ=3 or (new.pla_cond_activ=1 and new.pla_categori=4)) then 0
        when (new.pla_categori=3 and new.pla_t51=1) then 1
        when (new.pla_categori=3 and (new.pla_t51=2 or new.pla_t48b=1 or new.pla_t48b=2)) then 2
        when ((new.pla_categori=1 or new.pla_categori=2) and (new.pla_t48b=1 or new.pla_t48b=2)) then 3
        when (new.pla_t51=3 or new.pla_t48b>2) then 4
         else null end; 
...
--
-- TOC entry 470 (class 1255 OID 115428)
...
--
-- TOC entry 472 (class 1255 OID 115429)
...
--
-- TOC entry 473 (class 1255 OID 115430)
...
--
-- TOC entry 474 (class 1255 OID 115431)
...
--
-- TOC entry 475 (class 1255 OID 115432)
...
--
-- TOC entry 476 (class 1255 OID 115433)
...
--
-- TOC entry 477 (class 1255 OID 115434)
...
--
-- TOC entry 478 (class 1255 OID 115435)
...
--
-- TOC entry 479 (class 1255 OID 115438)
...
--
-- TOC entry 480 (class 1255 OID 115439)
...
--
-- TOC entry 481 (class 1255 OID 115440)
...
--
-- TOC entry 482 (class 1255 OID 115441)
...
--
-- TOC entry 483 (class 1255 OID 115442)
...
--
-- TOC entry 484 (class 1255 OID 115443)
-- Name: generar_consistencias_continuidad(); Type: FUNCTION; Schema: encu; Owner: tedede_php
--

CREATE OR REPLACE FUNCTION generar_consistencias_continuidad() RETURNS void
    LANGUAGE plpgsql
    AS $$
DECLARE
...
ALTER FUNCTION encu.generar_consistencias_continuidad() OWNER TO tedede_php;

--
-- TOC entry 485 (class 1255 OID 115444)
...
--
-- TOC entry 486 (class 1255 OID 115447)
...
--
-- TOC entry 487 (class 1255 OID 115450)
...
--
-- TOC entry 488 (class 1255 OID 115451)
...
--
-- TOC entry 489 (class 1255 OID 115454)
...
--
-- TOC entry 490 (class 1255 OID 115455)
...
--
-- TOC entry 491 (class 1255 OID 115456)
...
--
-- TOC entry 492 (class 1255 OID 115457)
...
--
-- TOC entry 493 (class 1255 OID 115458)
...
--
-- TOC entry 494 (class 1255 OID 115459)
...
--
-- TOC entry 495 (class 1255 OID 115460)
...
--
-- TOC entry 496 (class 1255 OID 115461)
...
--
-- TOC entry 497 (class 1255 OID 115462)
...
--
-- TOC entry 498 (class 1255 OID 115463)
...
--
-- TOC entry 499 (class 1255 OID 115464)
...
--
-- TOC entry 500 (class 1255 OID 115465)
...
--
-- TOC entry 501 (class 1255 OID 115466)
...
--
-- TOC entry 502 (class 1255 OID 115467)
...
--
-- TOC entry 503 (class 1255 OID 115468)
...
--
-- TOC entry 504 (class 1255 OID 115469)
...
--
-- TOC entry 505 (class 1255 OID 115470)
...
--
-- TOC entry 508 (class 1255 OID 115471)
...
--
-- TOC entry 509 (class 1255 OID 115472)
...
--
-- TOC entry 510 (class 1255 OID 115473)
...
--
-- TOC entry 444 (class 1255 OID 115474)
...
--
-- TOC entry 445 (class 1255 OID 115477)
...
--
-- TOC entry 446 (class 1255 OID 115478)
...
--
-- TOC entry 511 (class 1255 OID 115479)
...
--
-- TOC entry 183 (class 1259 OID 115511)
-- Name: a_ingreso; Type: TABLE; Schema: encu; Owner: tedede_php; Tablespace: 
--

--
-- TOC entry 3312 (class 2620 OID 116884)
...
--
-- TOC entry 3307 (class 2620 OID 116885)
...
--
-- TOC entry 3308 (class 2620 OID 116886)
...
--
-- TOC entry 3309 (class 2620 OID 116890)
...
--
-- TOC entry 3310 (class 2620 OID 116891)
...
--
-- TOC entry 3305 (class 2620 OID 116892)
-- Name: his_inconsistencias_trg; Type: TRIGGER; Schema: encu; Owner: tedede_php
--
DROP TRIGGER  his_inconsistencias_trg ON encu.inconsistencias;
...
--
-- TOC entry 3306 (class 2620 OID 116893)
-- Name: his_inconsistencias_upd_trg; Type: TRIGGER; Schema: encu; Owner: tedede_php
--
DROP TRIGGER  his_inconsistencias_upd_trg ON encu.inconsistencias;
...
--
-- TOC entry 3311 (class 2620 OID 116894)
-- Name: pase_a_procesamiento_trg; Type: TRIGGER; Schema: encu; Owner: tedede_php
--

CREATE TRIGGER pase_a_procesamiento_trg AFTER UPDATE ON plana_tem_ FOR EACH ROW EXECUTE PROCEDURE pase_a_procesamiento_trg();

ALTER TABLE plana_tem_ DISABLE TRIGGER pase_a_procesamiento_trg;


--
-- TOC entry 3313 (class 2620 OID 116895)
-- Name: respuestas_a_planas_trg; Type: TRIGGER; Schema: encu; Owner: tedede_php
--
DROP TRIGGER  respuestas_a_planas_trg ON encu.respuestas;
...
--
-- TOC entry 3314 (class 2620 OID 116896)
...
--
-- TOC entry 3315 (class 2620 OID 116897)
...
--
-- TOC entry 3316 (class 2620 OID 116898)
-- Name: respuestas_control_pk_trg; Type: TRIGGER; Schema: encu; Owner: tedede_php
--
DROP TRIGGER  respuestas_control_pk_trg ON encu.respuestas;
...
--
-- TOC entry 3317 (class 2620 OID 116899)
...
--
-- TOC entry 3318 (class 2620 OID 116900)
...
--
-- TOC entry 3320 (class 2620 OID 116901)
...
--
-- TOC entry 3321 (class 2620 OID 116902)
...
--
-- TOC entry 3319 (class 2620 OID 116903)
-- Name: variables_ins_trg; Type: TRIGGER; Schema: encu; Owner: tedede_php
--
DROP TRIGGER   variables_ins_trg ON encu.variables;
