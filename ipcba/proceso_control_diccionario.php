...
class Proceso_control_diccionario extends Proceso_Formulario{
    ...
    function responder(){
        ...
        enviar_grilla($this->salida,'vista_control_diccionario',array('periodo'=>$tra_periodo),'div_atributos');
