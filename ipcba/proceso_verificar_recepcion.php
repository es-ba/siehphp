...
class Proceso_verificar_recepcion extends Proceso_Formulario{
...
SQL
        ...
        $this->definir_parametros(array(
            ...
            'permisos'=>array('grupo'=>'analista','grupo1'=>'jefe_campo','grupo1'=>'recepcionista'),
            'submenu'=>'Recepción',
...
SQL
    ...
    function responder(){
        ...
        if(!!$this->argumentos->tra_tarea){
            ...
            return new Respuesta_Negativa('Debe especificar tarea!');        
        }    
        ...
        if(!!$this->argumentos->tra_panel) {
            ...
            return new Respuesta_Negativa('Debe especificar panel!');        
        }
    }
}
?>