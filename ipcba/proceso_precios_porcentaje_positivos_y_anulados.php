...
class proceso_precios_porcentaje_positivos_y_anulados extends Proceso_Formulario{
    ...
    function responder(){
        ...
        enviar_grilla($this->salida,'vista_precios_porcentaje_positivos_y_anulados',null,'div_controlatributos',array('filtro_manual'=>array('periodo'=>$tra_periodo)));
