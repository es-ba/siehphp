...
class Proceso_exportar_hdr_cierretemporal extends Proceso_Formulario{
    ...
    function responder(){
        ...
        enviar_grilla($this->salida,'vista_exportar_hdr_cierretemporal',null,'div_controlatributos',array('filtro_manual'=>array('periodo'=>$tra_periodo)));
