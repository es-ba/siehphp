...
class Proceso_control_relpre_1_sn extends Proceso_Formulario{
    ...
    function post_constructor(){
        ...
        $this->definir_parametros(array(
            ...
            'parametros'=>array(
                 'tra_periodo'=>array('tipo'=>'texto','label'=>'Periodo anterior'),
             ),
            'bitacora'=>true,
            'boton'=>array('id'=>'ver'),
        ));
    ...
    function responder(){
        ...
        enviar_grilla($this->salida,'vista_relpre_1_sn',array('periodo1'=>$tra_periodo),'div_atributos');
