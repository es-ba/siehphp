...
class Proceso_control_ingresados_calculo extends Proceso_Formulario{
    ...
    function responder(){
        ...
        enviar_grilla($this->salida,'vista_control_ingresados_calculo',null,'div_controlatributos',array('filtro_manual'=>array('periodo'=>$tra_periodo)));
