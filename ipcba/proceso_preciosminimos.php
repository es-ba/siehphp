...
class Proceso_preciosminimos extends Proceso_Formulario{
    ...
    function responder(){
        ...
        enviar_grilla($this->salida,'vista_precios_minimos_vw',null,'div_controlatributos',array('filtro_manual'=>array('periodo'=>$tra_periodo)));
