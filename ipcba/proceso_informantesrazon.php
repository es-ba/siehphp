...
class Proceso_informantesrazon extends Proceso_Formulario{
    ...
    function responder(){
        ...
        enviar_grilla($this->salida,'vista_informantesrazon',null,'div_controlatributos',array('filtro_manual'=>array('periodo'=>$periodos_para_filtro)));
