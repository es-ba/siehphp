...
class Proceso_control_anulados_recep extends Proceso_Formulario{
    ...
    function responder(){
        ...
        enviar_grilla($this->salida,'vista_control_anulados_recep',null,'div_controlatributos',array('filtro_manual'=>array('periodo'=>$tra_periodo)));
