...
class Vista_exportar_reemplazos extends Vistas{
    function definicion_estructura(){
        ...
        $this->definir_campo('fechasalida'                  ,array('tipo'=>'timestamp', 'es_pk'=>true, 'origen'=>'fechasalida'));
        $this->definir_campo('conjuntomuestral'             ,array('tipo'=>'entero', 'es_pk'=>true, 'origen'=>'conjuntomuestral'));
        $this->definir_campo('encuestador'                  ,array('tipo'=>'texto', 'es_pk'=>true, 'origen'=>'encuestador'));
