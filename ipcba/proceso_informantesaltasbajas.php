...
class Proceso_informantesaltasbajas extends Proceso_Formulario{
    ...
    function responder(){
        ...
        enviar_grilla($this->salida,'vista_informantesaltasbajas',null,'div_controlatributos',array('filtro_manual'=>array('periodo'=>$tra_periodo)));
