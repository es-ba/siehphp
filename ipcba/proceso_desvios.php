...
class Proceso_desvios extends Proceso_Formulario{
    ...
    function responder(){
        ...
        enviar_grilla($this->salida,'vista_desvios',null,'div_controlatributos',array('filtro_manual'=>array('periodo'=>$tra_periodo)));
