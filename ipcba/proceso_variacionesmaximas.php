...
class Proceso_variacionesmaximas extends Proceso_Formulario{
    ...
    function responder(){
        ...
        enviar_grilla($this->salida,'vista_variaciones_maximas_vw',null,'div_controlatributos',array('filtro_manual'=>array('periodo'=>$tra_periodo)));
