...
class Proceso_hojaderuta_supervisor extends Proceso_Formulario{
...
SQL
    ...
    function responder(){
        ...
        $filtro_hdr=array('periodo'=>$this->argumentos->tra_periodo,'panel'=>$this->argumentos->tra_panel);
        //if(!!$this->argumentos->tra_tarea){
        //    $filtro_hdr['tarea']=$this->argumentos->tra_tarea;
        //}    
        //Loguear('2014-04-08','ingreso: ------------- '.var_export($filtro_hdr,true));

        //if(!!$this->argumentos->tra_panel) {
            $this->salida=new Armador_de_salida(true);
            $this->salida->enviar('','',array('id'=>'div_relvis'));
            enviar_grilla($this->salida,'vista_hojaderutasupervisor',$filtro_hdr,'div_relvis');
