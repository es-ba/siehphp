...
class Tabla_novdelobs extends Tabla{
...
class Grilla_novdelobs extends Grilla_tabla{
    function iniciar($nombre_del_objeto_base){
        $this->nombre_grilla="novdelobs";
        $this->tabla_o_vista=$this->tabla=$this->contexto->nuevo_objeto("tabla_novdelobs");
        ...
        $this->tabla->tablas_lookup=array(
            ...
            "(SELECT n.periodo as per, n.producto as prod, n.observacion as obs, n.informante as inf, n.visita as vis, 
			 ...
			 =>'u.per=periodo and u.prod = producto and u.obs = observacion and u.inf = informante and u.vis = visita',			
        );
    }
