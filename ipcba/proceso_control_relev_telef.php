...
class Proceso_control_relev_telef extends Proceso_Formulario{
    ...
    function responder(){
        ...
        enviar_grilla($this->salida,'vista_control_relev_telef',null,'div_relevtelef',array('filtro_manual'=>array('periodo'=>$tra_periodo,'panel'=>$mifiltro)));
