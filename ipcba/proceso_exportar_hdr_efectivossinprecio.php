...
class Proceso_exportar_hdr_efectivossinprecio extends Proceso_Formulario{
    ...
    function responder(){
        ...
        enviar_grilla($this->salida,'vista_exportar_hdr_efectivossinprecio',null,'div_controlatributos',array('filtro_manual'=>array('periodo'=>$tra_periodo)));
