...
class Proceso_exportar_hojas_ruta extends Proceso_Formulario{
    ...
    function responder(){
        ...
        enviar_grilla($this->salida,'vista_exportar_hojas_ruta',null,'div_controlatributos',array('filtro_manual'=>array('periodo'=>$tra_periodo)));
