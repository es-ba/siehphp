...
class Proceso_controlvigencias extends Proceso_Formulario{
    ...
    function responder(){
        ...
        enviar_grilla($this->salida,'vista_controlvigencias',null,'div_controlatributos',array('filtro_manual'=>array('periodo'=>$tra_periodo)));
