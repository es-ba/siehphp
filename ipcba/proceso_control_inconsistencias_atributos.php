...
class Proceso_control_inconsistencias_atributos extends Proceso_Formulario{
    ...
    function post_constructor(){
        ...
        $this->definir_parametros(array(
            ...
            'permisos'=>array('grupo'=>'analista','grupo1'=>'jefe_campo','grupo2'=>'recepcionista','grupo3'=>'recep_gabinete'),
            'submenu'=>'Gabinete',
    ...
    function responder(){
        ...
        enviar_grilla($this->salida,'vista_control_atributos',null,'div_controlatributos',array('filtro_manual'=>array('periodo'=>$tra_periodo,'panel'=>$mifiltro)));
