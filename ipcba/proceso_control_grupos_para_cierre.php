...
class Proceso_control_grupos_para_cierre extends Proceso_Formulario{
    ...
    function responder(){
        ...
        enviar_grilla($this->salida,'vista_control_grupos_para_cierre',null,'div_controlatributos',array('filtro_manual'=>array('periodo'=>$tra_periodo)));
