...
class Proceso_informantesrubro extends Proceso_Formulario{
    ...
    function responder(){
        ...
        enviar_grilla($this->salida,'vista_informantesrubro',null,'div_controlatributos',array('filtro_manual'=>array('periodo'=>$periodos_para_filtro)));
