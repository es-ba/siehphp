...
class Proceso_control_tipoprecio extends Proceso_Formulario{
    ...
    function responder(){
        ...
        enviar_grilla($this->salida,'vista_control_tipoprecio',null,'div_controlatributos',array('filtro_manual'=>array('periodo'=>$periodos_para_filtro)));
