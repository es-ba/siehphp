...
class Proceso_control_normalizables_sindato extends Proceso_Formulario{
    ...
    function responder(){
        ...
        enviar_grilla($this->salida,'vista_control_normalizables_sindato',null,'div_controlatributos',array('filtro_manual'=>array('periodo'=>$tra_periodo)));
