...
-- solo para proyecto sin supervisión aleatoria como ebcp2014
...
BEGIN
  ...
  then
    if new.res_var='verificado_enc' and new.res_valor::integer=5 then  
       select pla_cod_enc into v_cod_enc 
       ...
       UPDATE encu.respuestas
        SET res_valor=v_cod_enc, res_valesp=null, res_valor_con_error=null, res_tlg=new.res_tlg
        WHERE res_ope=new.res_ope
          ...
          and res_var='cod_enc_2'; -- pk_verificada  
       UPDATE encu.respuestas
        ...
        WHERE res_ope=new.res_ope
          ...
          and res_mie=new.res_mie 
          and res_exm=new.res_exm /*G:PK*/ 
          and res_var in ('fecha_carga_enc','cod_enc'); -- pk_verificada    
    end if;
    select pla_reserva, pla_nro_enc_de_baja
      into   v_reserva, v_nro_enc_de_baja
      from encu.plana_tem_
      where pla_enc=new.res_enc and pla_hog=new.res_hog and pla_mie=new.res_mie and pla_exm=new.res_exm; 
