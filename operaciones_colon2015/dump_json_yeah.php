<?php
set_include_path(get_include_path() . PATH_SEPARATOR . "../colon2015");
...
$parametros_db->base_de_datos='colon2015_produc_db';
...
file_put_contents("yCOLON_dump.json",json_dump('encu',$que_tablas,$jerarquia));
?>