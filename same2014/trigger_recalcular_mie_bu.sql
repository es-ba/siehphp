...
INSERT INTO encu.varcal(
    ...
    VALUES ('same2014', 'mie_bu', 'mie',4800 , 'Número de miembro para Base usuarios',null, 1, TRUE, 'especial', TRUE, 'mie_bu','entero');
...
$BODY$
    ...
    if TG_OP='UPDATE' then
       if new.pla_enc is distinct from old.pla_enc then
          select /*perform*/  recalcular_mie_bu(old.pla_enc);
          select /*perform*/  recalcular_mie_bu(new.pla_enc);
...
select pla_enc, pla_mie, pla_mie_bu 
from encu.plana_i1_
order by pla_enc, pla_mie;
...
update encu.respuestas set res_valor = '0'
 where res_ope ='same2014' and res_for='TEM' and res_mat = '' and res_enc = 130009 and res_hog = 0 and res_mie = 0 and res_var = 'fin_anacon';
...
update encu.respuestas set res_valor = 2
 where res_ope ='same2014' and res_for='S1' and res_mat = 'P' and res_enc = 130009 and res_hog = 1 and res_mie = 1 and res_var = 'p4';
update encu.respuestas set res_valor = 1P
 where res_ope ='same2014' and res_for='S1' and res_mat = 'P' and res_enc = 130009 and res_hog = 1 and res_mie = 4 and res_var = 'p4';
...
update encu.respuestas set res_mie = 4 where res_ope = 'same2014' and res_for='S1' and res_mat = 'P' and res_enc = 130016 and res_hog = 1 and res_mie = 3;
update encu.respuestas set res_mie = 4 where res_ope = 'same2014' and res_for='I1' and res_mat = '' and res_enc = 130016 and res_hog = 1 and res_mie = 3;
