...
revisar 
##DETALLE
existía y en ebcp tiene que ser distinta porque no está la variable h2
##PROVISORIO
  ...
  LOOP
    ...
    LOOP
        ...
        LOOP
           ...
           v_expresion:= regexp_replace(v_expresion, '\mnew.pla_(edad|sexo|f_nac_o|p4|p5|p5b|p6_a|p6_b|comuna|dominio|estado|h2|h3|v2|v4|v5|v5_esp|v6|v7|v12|h20_1|h20_2|h20_17|h20_18|h20_5|h20_6|h20_7|h20_15|h20_8|h20_19|h20_12|h20_11|h20_14)\M'::text, 'v_\1'::text,'ig');
           ...
           v_expresion_valor:= regexp_replace(v_expresion_valor, '\mnew.pla_(edad|sexo|f_nac_o|p4|p5|p5b|p6_a|p6_b|comuna|dominio|h2|h3|v2|v4|v5|v5_esp|v6|v7|v12|h20_1|h20_2|h20_17|h20_18|h20_5|h20_6|h20_7|h20_15|h20_8|h20_19|h20_12|h20_11|h20_14)\M'::text, 'v_\1'::text,'ig');
    ...
    IF v_sentencia<>'' THEN
        ...
        FOR v_variables_declare in
            select v_vari, v_tipo from (
               ...
               union select 'v_dominio'::text   as v_vari, 'integer'::text as v_tipo
               ...
               union select 'v_v4'::text        as v_vari, 'integer'::text as v_tipo
               union select 'v_v5'::text        as v_vari, 'integer'::text as v_tipo
               union select 'v_v5_esp'::text    as v_vari, 'text'::text as v_tipo
               union select 'v_v6'::text        as v_vari, 'integer'::text as v_tipo
               union select 'v_v7'::text        as v_vari, 'integer'::text as v_tipo
               union select 'v_v12'::text       as v_vari, 'integer'::text as v_tipo               
               union select 'v_h20_1'::text     as v_vari, 'integer'::text as v_tipo
               union select 'v_h20_2'::text     as v_vari, 'integer'::text as v_tipo
               union select 'v_h20_17'::text    as v_vari, 'integer'::text as v_tipo
               union select 'v_h20_18'::text    as v_vari, 'integer'::text as v_tipo
               union select 'v_h20_5'::text     as v_vari, 'integer'::text as v_tipo
               union select 'v_h20_6'::text     as v_vari, 'integer'::text as v_tipo
               union select 'v_h20_7'::text     as v_vari, 'integer'::text as v_tipo
               union select 'v_h20_15'::text    as v_vari, 'integer'::text as v_tipo
               union select 'v_h20_8'::text     as v_vari, 'integer'::text as v_tipo
               union select 'v_h20_19'::text    as v_vari, 'integer'::text as v_tipo
               union select 'v_h20_12'::text    as v_vari, 'integer'::text as v_tipo
               union select 'v_h20_11'::text    as v_vari, 'integer'::text as v_tipo
               union select 'v_h20_14'::text    as v_vari, 'integer'::text as v_tipo
            ) x
        LOOP
            v_declare:=v_declare||'
...
-- en el caso de variables del bloque Viv, hay que leer el hogar 1
            FOR v_variables_otro_formulario in
                select v_vari, coalesce(pre_blo,'') as v_blo, v_formu from (
                   ...
                   union select 'dominio'::text   as v_vari,  'TEM'::text as v_formu
                   ...
                   union select 'v4'::text        as v_vari,  'A1'::text as v_formu
                   union select 'v5'::text        as v_vari,  'A1'::text as v_formu
                   union select 'v5_esp'::text    as v_vari,  'A1'::text as v_formu
                   union select 'v6'::text        as v_vari,  'A1'::text as v_formu
                   union select 'v7'::text        as v_vari,  'A1'::text as v_formu
                   union select 'v12'::text       as v_vari,  'A1'::text as v_formu
                   union select 'h20_1'::text     as v_vari,  'A1'::text as v_formu
                   union select 'h20_2'::text     as v_vari,  'A1'::text as v_formu
                   union select 'h20_17'::text    as v_vari,  'A1'::text as v_formu
                   union select 'h20_18'::text    as v_vari,  'A1'::text as v_formu
                   union select 'h20_5'::text     as v_vari,  'A1'::text as v_formu
                   union select 'h20_6'::text     as v_vari,  'A1'::text as v_formu
                   union select 'h20_7'::text     as v_vari,  'A1'::text as v_formu
                   union select 'h20_15'::text    as v_vari,  'A1'::text as v_formu
                   union select 'h20_8'::text     as v_vari,  'A1'::text as v_formu
                   union select 'h20_19'::text    as v_vari,  'A1'::text as v_formu
                   union select 'h20_12'::text    as v_vari,  'A1'::text as v_formu
                   union select 'h20_11'::text    as v_vari,  'A1'::text as v_formu
                   union select 'h20_14'::text    as v_vari,  'A1'::text as v_formu
        ...
        EXECUTE v_script_creador;
          BEGIN
           ...
           v_sentencia= ' update encu.plana_'||v_destinos.plana_destino||sent_set;
...
$BODY$
    BEGIN
    if new.pla_h2 is distinct from old.pla_h2 or new.pla_h3 is distinct from old.pla_h3 or new.pla_h20_1 is distinct from old.pla_h20_1 
       or new.pla_v2 is distinct from old.pla_v2 or new.pla_v4 is distinct from old.pla_v4 or new.pla_v12 is distinct from old.pla_v12
       or new.pla_v5 is distinct from old.pla_v5 or new.pla_v5_esp is distinct from old.pla_v5_esp or new.pla_v6 is distinct from old.pla_v6 or new.pla_v7 is distinct from old.pla_v7
       or new.pla_h20_2 is distinct from old.pla_h20_2 or new.pla_h20_17 is distinct from old.pla_h20_17 or new.pla_h20_18 is distinct from old.pla_h20_18 
       or new.pla_h20_5 is distinct from old.pla_h20_5 or new.pla_h20_6 is distinct from old.pla_h20_6 or new.pla_h20_7 is distinct from old.pla_h20_7
       or new.pla_h20_15 is distinct from old.pla_h20_15 or new.pla_h20_8 is distinct from old.pla_h20_8 or new.pla_h20_19 is distinct from old.pla_h20_19
       or new.pla_h20_12 is distinct from old.pla_h20_12 or new.pla_h20_11 is distinct from old.pla_h20_11 or new.pla_h20_14 is distinct from old.pla_h20_14 then
