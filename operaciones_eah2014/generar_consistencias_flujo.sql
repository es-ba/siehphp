ALTER TABLE encu.consistencias ALTER COLUMN con_postcondicion TYPE character varying(2000);
/*otra*/
ALTER TABLE encu.consistencias ALTER COLUMN con_explicacion TYPE character varying(700);
/*otra*/

UPDATE encu.variables
        set var_orden=1
        where var_ope='eah2014' and var_var='v5_esp';
/*otra*/
UPDATE encu.variables
        set var_orden=1
        where var_ope='eah2014' and var_var='lugar_esp1';
/*otra*/
UPDATE encu.variables
        set var_orden=3
        where var_ope='eah2014' and var_var='lugar_esp3';
/*otra*/
UPDATE encu.variables
        set var_orden=12
        where var_ope='eah2014' and var_var='sn15k_esp';
/*otra*/        
...
--SELECT encu.variables_saltadas('eah2014','t3','t13'), ('t3') --{t4,t5,t6,t7,t8,t8_otro,t9,t10,t11,t11_otro,t12}
/*otra*/
