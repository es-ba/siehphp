...
update encu.operativos set ope_ope_anterior='etoi244' where ope_ope='prp_acj2025';
INSERT INTO encu.operativos(
    ...
    ( 'eah2024', 'Encuesta Anual de Hogares 2024', false, false, 1);
...
select      'eah2024', mat_for, mat_mat, mat_texto, mat_ua, mat_ultimo_campo_pk, 
    ...
    where mat_ope = 'prp_acj2025' and mat_for in ('A1', 'S1');    
...
from encu.respuestas
where res_ope <> 'prp_acj2025' and res_enc 
...
from encu.respuestas
where res_ope <> 'prp_acj2025' and res_var='s1a1_obs' --and res_hog >1
--group by 1,2,3,4,5
--having count(*) >1
