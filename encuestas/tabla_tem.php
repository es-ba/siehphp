    ...
    function definicion_estructura(){
        ...
        //a partir de etoi201
         if ( $GLOBALS['anio_operativo']>=2020 && 
              ( substr($GLOBALS['NOMBRE_APP'],0,3)=='eah'||substr($GLOBALS['NOMBRE_APP'],0,4)=='etoi' || substr($GLOBALS['NOMBRE_APP'],0,5)=='preju')|| substr($GLOBALS['NOMBRE_APP'],0,3)=='vcm'|| substr($GLOBALS['NOMBRE_APP'],4,3)=='acj'){ 
