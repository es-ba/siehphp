...
class Grilla_vcm_S1 extends  Grilla_respuestas_para_proc{
    ...
    function iniciar($nombre_del_objeto_base){
       ...
       //$this->tabla->campos_lookup['pla_hog']=false;
    }
...
//enc	comuna	norea_enc	norea_recu	cnombre	hn	hp	hd	hab	rea	norea_1	norea_2	estado	result_sup	norea_Sup	obs_S1 	obs_grilla_no

class Grilla_vcm_norea extends Grilla_vcm_S1{ 
    function iniciar($nombre_del_objeto_base){
        parent::iniciar('S1_');
    }
    function campos_solo_lectura(){
    ...
    function campos_a_listar($filtro_para_lectura){
        return array_merge(array('pla_enc', 'pla_hog','pla_mie',
            ...
            'pla_s1a1_obs', 'pla_obs_grilla_no')
        );
    }
