        ...
        $parametros_proceso=array(
            ...
            'funcion'=>function(Procesos $este) use ($para_supervisor){
                $este->salida->abrir_grupo_interno('cabezal_matriz',array('id'=>'encabezado_pagina'));
                    ...
                    $este->salida->enviar(AUTF8_NBSP.AUTF8_NBSP.AUTF8_NBSP.AUTF8_NBSP.AUTF8_NBSP.($para_supervisor?' hoja de ruta Supervisor':'HOJA DE RUTA').' v 3.04c  '.AUTF8_NBSP.AUTF8_NBSP.AUTF8_NBSP,'',array('tipo'=>'span', 'id'=>'hdr_version'));
