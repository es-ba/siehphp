...
var version_js_encuestas='v 3.15';
...
function Llenar_rta_ud(formulario,matriz,invisible){
   ...
   // if(pk_ud.tra_ope==operativo_actual && ( (pk_ud.tra_for=='A1' && operativo_actual=='ppmulti' ) || (pk_ud.tra_for=='PMD' && operativo_actual=='eah2019') ) ){ // OJO: GENERALIZAR OPERATIVO
    ...
    if(!invisible && !matriz){ // No soy el ud de una matriz, estoy en el ud principal de un formulario
        ...
        if(formulario=='S1' && ( operativo_actual=='eah2014'|| operativo_actual=='eah2018'|| operativo_actual=='eah2022'|| operativo_actual=='eah2026') ){
        ...
        if(formulario=='S1' && (operativo_actual=='eah2019' || operativo_actual=='eah2021'|| operativo_actual=='eah2025') ){
...
function grabar_y_salir(){
    if(grabar_si_es_necesario_o_seguir()){
        ...
        //para que muestre bien la info de la grilla de Personas al volver del S1p
        if(soy_un_ipad){
...
function operativo_con_residente(pOpe){
    ...
    if (['eah2024', 'eah2025', 'eah2026','etoi244','etoi251','prp_acj2025','etoi252','etoi254','etoi261', 'etoi262','etoi264'].includes(pOpe)){ 
        v_residente=true;
    }
    return v_residente;
}