...
/*OTRA*/  
ALTER FUNCTION dbo.es_fecha(text)
  OWNER TO tedede_php;
##CASOS_SQL
select dbo.es_fecha('01/12/2015');--1
select dbo.es_fecha('0/4/2014');--0
select dbo.es_fecha('1/31/2014');--0
select dbo.es_fecha('4/1/2015');--1
select dbo.es_fecha('2/2');--1 completa el año con el año actual
