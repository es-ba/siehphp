...
DROP FUNCTION if exists encu.nombre_largo_para_documentacion(text,text);
/*otra*/
CREATE OR REPLACE FUNCTION encu.nombre_largo_para_documentacion(p_var text, p_baspro text)
  RETURNS text AS
$BODY$
DECLARE
...
/*otra*/
ALTER FUNCTION encu.nombre_largo_para_documentacion(text,text)
  OWNER TO tedede_php;
