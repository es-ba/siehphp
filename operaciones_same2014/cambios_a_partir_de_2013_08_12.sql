...
select * from encu.respuestas where res_ope='same2014' and res_enc='100004'
...
"cr_num_miembro=1"
select * from encu.respuestas where res_ope='same2014' and res_enc= '100006' and res_for='SM1'
