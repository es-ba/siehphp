  ...
  LOOP
    ...
    LOOP
        ...
        LOOP
           ...
           v_expresion:= regexp_replace(v_expresion, '\mnew.pla_(edad|sexo|f_nac_o|p4|p5|p5b|p6_a|p6_b|comuna|estado|h2|h3|v2)\M'::text, 'v_\1'::text,'ig');
           ...
           v_expresion_valor:= regexp_replace(v_expresion_valor, '\mnew.pla_(edad|sexo|f_nac_o|p4|p5|p5b|p6_a|p6_b|comuna|h2|h3|v2)\M'::text, 'v_\1'::text,'ig');
    ...
    FOR vvar IN
      ...
      LOOP
        ...
        loop            
           ...
           r_saltadas=encu.variables_saltadas(p_operativo, vvar.sal_var, vopc_s.var_destino );
      ...
      LOOP
          -- var_destino, str_saltadas, cond_saltadas, var_destino_optativa, expresion_habilitar_destino
            SELECT v.var_var, v.var_optativa, v.var_expresion_habilitar
                ...
                FROM encu.variables_ordenadas v 
                WHERE v.var_ope= p_operativo AND 
                ...
                LIMIT 1;
            r_saltadas=encu.variables_saltadas(p_operativo, v_nsnc.var_var, nsnc_destino );
