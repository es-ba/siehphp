"use strict";
var version_js_seleccion_miembro_sup='v 3.07a';
...
window.addEventListener('load',function(){
    if(document.getElementById('var_sv_tp') && operativo_actual=='vcm2023'){
   ...
   // var letra_manual=dominio==5;
    ...
    if(solo_controla){
        ...
        if(grabar_si_es_necesario_o_seguir()){
            setTimeout(function(){
                ir_a_url('vcm2023.php?hacer=desplegar_formulario&todo={"tra_ope":"vcm2023","tra_for":"SUP","tra_mat":""}');
            },200);
        }
    }
}
