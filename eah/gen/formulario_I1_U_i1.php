...
<td><table id='interna_opciones'><colgroup><col><col><col><col><col><col><col><col></colgroup><tr><td colspan=3><td colspan=1><span class='respuesta'  title='info_numero'><input id='var_relacion' name='var_relacion' type='number' readonly=readonly class='input_info_numero' onblur='ValidarOpcion("var_relacion");' onKeyPress='PresionTeclaEnVariable("var_relacion",event);' onKeyDown='PresionOtraTeclaEnVariable("var_relacion",event);' ></span>
...
<td><table id='interna_opciones'><colgroup><col><col><col><col><col><col><col><col></colgroup><tr><td colspan=3><td colspan=1><span class='respuesta'  title='mes'><input id='var_u3_mes' name='var_u3_mes' type='number'  class='input_mes' onblur='ValidarOpcion("var_u3_mes");' onKeyPress='PresionTeclaEnVariable("var_u3_mes",event);' onKeyDown='PresionOtraTeclaEnVariable("var_u3_mes",event);' ></span>
</td><td colspan=3></td></tr>
</table>
<tr class='fila_pregunta'>
<td>
...
<td><table id='interna_opciones'><colgroup><col><col><col><col><col><col><col><col></colgroup><tr><td colspan=3><td colspan=1><span class='respuesta'  title='anio'><input id='var_u3_anio' name='var_u3_anio' type='number'  class='input_anio' onblur='ValidarOpcion("var_u3_anio");' onKeyPress='PresionTeclaEnVariable("var_u3_anio",event);' onKeyDown='PresionOtraTeclaEnVariable("var_u3_anio",event);' ></span>
</td><td colspan=3></td></tr>
</table>
<tr class='fila_pregunta'>
<td>
...
<td><table id='interna_opciones'><colgroup><col><col><col><col><col><col><col><col></colgroup><tr><td colspan=3><td colspan=1><span class='respuesta'  title='mes'><input id='var_u4_mes' name='var_u4_mes' type='number'  class='input_mes' onblur='ValidarOpcion("var_u4_mes");' onKeyPress='PresionTeclaEnVariable("var_u4_mes",event);' onKeyDown='PresionOtraTeclaEnVariable("var_u4_mes",event);' ></span>
</td><td colspan=3></td></tr>
</table>
<tr class='fila_pregunta'>
<td>
...
<td><table id='interna_opciones'><colgroup><col><col><col><col><col><col><col><col></colgroup><tr><td colspan=3><td colspan=1><span class='respuesta'  title='anio'><input id='var_u4_anio' name='var_u4_anio' type='number'  class='input_anio' onblur='ValidarOpcion("var_u4_anio");' onKeyPress='PresionTeclaEnVariable("var_u4_anio",event);' onKeyDown='PresionOtraTeclaEnVariable("var_u4_anio",event);' ></span>
</td><td colspan=3></td></tr>
</table>
<tr class='fila_pregunta'>
<td>
...
<td><table id='interna_opciones'><colgroup><col><col><col><col><col><col><col><col></colgroup><tr><td colspan=3><td colspan=1><span class='respuesta'  title='opciones'><input id='var_u5' name='var_u5' type='number'  class='input_opciones' onblur='ValidarOpcion("var_u5");' onKeyPress='PresionTeclaEnVariable("var_u5",event);' onKeyDown='PresionOtraTeclaEnVariable("var_u5",event);' ></span>
...
<td><table id='interna_opciones'><colgroup><col><col><col><col><col><col><col><col></colgroup><tr><td colspan=3><td colspan=1><span class='respuesta'  title='opciones'><input id='var_u6' name='var_u6' type='number'  class='input_opciones' onblur='ValidarOpcion("var_u6");' onKeyPress='PresionTeclaEnVariable("var_u6",event);' onKeyDown='PresionOtraTeclaEnVariable("var_u6",event);' ></span>
