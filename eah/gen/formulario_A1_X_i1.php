...
<td><table id='interna_opciones'><colgroup><col><col><col><col><col><col><col><col></colgroup><tr><td colspan=3><td colspan=1><span class='respuesta'  title='info_numero'><input id='var_ex_miembro' name='var_ex_miembro' type='number' readonly=readonly class='input_info_numero' onblur='ValidarOpcion("var_ex_miembro");' onKeyPress='PresionTeclaEnVariable("var_ex_miembro",event);' onKeyDown='PresionOtraTeclaEnVariable("var_ex_miembro",event);' ></span>
</td><td colspan=3></td></tr>
</table>
<tr class='fila_pregunta'>
<td>
<span class='pre_texto' id='pre_sexo_ex'>Sexo</span>
<td><table id='interna_opciones'><colgroup><col><col><col><col><col><col><col><col></colgroup><tr><td colspan=3><td colspan=1><span class='respuesta'  title='opciones'><input id='var_sexo_ex' name='var_sexo_ex' type='number'  class='input_opciones' onblur='ValidarOpcion("var_sexo_ex");' onKeyPress='PresionTeclaEnVariable("var_sexo_ex",event);' onKeyDown='PresionOtraTeclaEnVariable("var_sexo_ex",event);' ></span>
...
<td><table id='interna_opciones'><colgroup><col><col><col><col><col><col><col><col></colgroup><tr><td colspan=3><td colspan=1><span class='respuesta'  title='opciones'><input id='var_pais_nac' name='var_pais_nac' type='number'  class='input_opciones' onblur='ValidarOpcion("var_pais_nac");' onKeyPress='PresionTeclaEnVariable("var_pais_nac",event);' onKeyDown='PresionOtraTeclaEnVariable("var_pais_nac",event);' ></span>
...
<td><table id='interna_opciones'><colgroup><col><col><col><col><col><col><col><col></colgroup><tr><td colspan=3> <span class='opc_aclaracion'>En años cumplidos</span><td colspan=1><span class='respuesta'  title='edad'><input id='var_edad_ex' name='var_edad_ex' type='number'  class='input_edad' onblur='ValidarOpcion("var_edad_ex");' onKeyPress='PresionTeclaEnVariable("var_edad_ex",event);' onKeyDown='PresionOtraTeclaEnVariable("var_edad_ex",event);' ></span>
</td><td colspan=3></td></tr>
</table>
<tr class='fila_pregunta'>
<td>
<span class='pre_texto' id='pre_niv_educ'>Nivel educativo al momento de irse</span>
<td><table id='interna_opciones'><colgroup><col><col><col><col><col><col><col><col></colgroup><tr><td colspan=3><td colspan=1><span class='respuesta'  title='opciones'><input id='var_niv_educ' name='var_niv_educ' type='number'  class='input_opciones' onblur='ValidarOpcion("var_niv_educ");' onKeyPress='PresionTeclaEnVariable("var_niv_educ",event);' onKeyDown='PresionOtraTeclaEnVariable("var_niv_educ",event);' ></span>
...
<td><table id='interna_opciones'><colgroup><col><col><col><col><col><col><col><col></colgroup><tr><td colspan=3><td colspan=1><span class='respuesta'  title='anio'><input id='var_anio' name='var_anio' type='number'  class='input_anio' onblur='ValidarOpcion("var_anio");' onKeyPress='PresionTeclaEnVariable("var_anio",event);' onKeyDown='PresionOtraTeclaEnVariable("var_anio",event);' ></span>
</td><td colspan=3></td></tr>
</table>
<tr class='fila_pregunta'>
<td>
<span class='pre_texto' id='pre_lugar'>A que lugar se fué?</span>
<td><table id='interna_opciones'><colgroup><col><col><col><col><col><col><col><col></colgroup><tr><td colspan=3><td colspan=1><span class='respuesta'  title='opciones'><input id='var_lugar' name='var_lugar' type='number'  class='input_opciones' onblur='ValidarOpcion("var_lugar");' onKeyPress='PresionTeclaEnVariable("var_lugar",event);' onKeyDown='PresionOtraTeclaEnVariable("var_lugar",event);' ></span>
